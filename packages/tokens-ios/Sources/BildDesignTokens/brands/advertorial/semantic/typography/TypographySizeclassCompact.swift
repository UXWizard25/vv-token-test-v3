...
//
// Brand: Advertorial | Context: Typography compact
//
...
public protocol AdvertorialTypographyScheme: DesignTypographyScheme {
...
public struct AdvertorialTypographyCompact: AdvertorialTypographyScheme, DesignTypographyScheme {
    public static let shared = AdvertorialTypographyCompact()
    private init() {}
