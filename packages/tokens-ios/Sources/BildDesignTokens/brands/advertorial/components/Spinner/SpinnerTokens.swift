...
///   SpinnerTokens.Density.current(for: theme.density).contentGap
public enum SpinnerTokens {

    // MARK: - Sizing

    /// Sizing tokens protocol
    public protocol SpinnerSizingTokens: Sendable {
    ...
    public enum Sizing {
        ...
        public static func current(for sizeClass: SizeClass) -> any SpinnerSizingTokens {
        ...
        public struct Compact: SpinnerSizingTokens {
        ...
        public struct Regular: SpinnerSizingTokens {
