...
//
// Brand: Bild | Context: Typography compact
//
...
public protocol BildTypographyScheme: DesignTypographyScheme {
...
public struct BildTypographyCompact: BildTypographyScheme, DesignTypographyScheme {
    public static let shared = BildTypographyCompact()
    private init() {}
