...
//
// Brand: Sportbild | Context: Effects light
//
...
public protocol SportbildEffectsScheme: Sendable {
...
public struct SportbildEffectsLight: SportbildEffectsScheme, DesignEffectsScheme {
    public static let shared = SportbildEffectsLight()
    private init() {}
