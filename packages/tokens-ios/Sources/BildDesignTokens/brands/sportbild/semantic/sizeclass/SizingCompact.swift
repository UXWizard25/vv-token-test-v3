...
//
// Brand: Sportbild | Context: SizingScheme compact
//
...
public protocol SportbildSizingScheme: Sendable {
...
public struct SportbildSizingCompact: SportbildSizingScheme, DesignSizingScheme {
    public static let shared = SportbildSizingCompact()
    private init() {}
    ...
    public let title1fontSize: CGFloat = 24
    public let title2fontSize: CGFloat = 16
    public let display1fontSize: CGFloat = 38
    public let display2fontSize: CGFloat = 34
    public let display3fontSize: CGFloat = 27
    public let headline1fontSize: CGFloat = 42
    public let headline2fontSize: CGFloat = 42
    public let headline3fontSize: CGFloat = 30
    public let headline4fontSize: CGFloat = 21
    ...
    public let footnote1fontSize: CGFloat = 13
    public let footnote2fontSize: CGFloat = 10
    public let kicker1fontSize: CGFloat = 20
    public let kicker2fontSize: CGFloat = 16
    public let kicker3fontSize: CGFloat = 16
    public let kicker4fontSize: CGFloat = 14
    public let subheadline1fontSize: CGFloat = 18
    ...
    public let kicker2lineHeight: CGFloat = 17.6
    public let kicker1lineHeight: CGFloat = 22
    ...
    public let title1lineHeight: CGFloat = 26.4
    public let title2lineHeight: CGFloat = 20.8
    public let quoteLineHeight: CGFloat = 20.8
    public let footnote1lineHeight: CGFloat = 17.03
    public let footnote2lineHeight: CGFloat = 13
    public let headline1lineHeight: CGFloat = 42
    public let headline2lineHeight: CGFloat = 42
    public let headline3lineHeight: CGFloat = 33
    public let headline4lineHeight: CGFloat = 23.1
    public let calloutLineHeight: CGFloat = 23.4
    public let subheadline1lineHeight: CGFloat = 23.4
