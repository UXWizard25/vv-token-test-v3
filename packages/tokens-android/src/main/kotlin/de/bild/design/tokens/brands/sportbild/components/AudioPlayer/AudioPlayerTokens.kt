...
object AudioPlayerTokens {
    ...
    object Typography {
        ...
        object Compact : TypographyTokens {
            override val audioPlayerLabel = DesignTextStyle(fontFamily = "AntennaExtraCond", fontWeight = FontWeight.Bold, fontSize = 16.sp, lineHeight = 16.sp, letterSpacing = 0.sp, textCase = DesignTextCase.Original, textDecoration = TextDecoration.None)
        }
        object Medium : TypographyTokens {
            override val audioPlayerLabel = DesignTextStyle(fontFamily = "AntennaExtraCond", fontWeight = FontWeight.Bold, fontSize = 16.sp, lineHeight = 16.sp, letterSpacing = 0.sp, textCase = DesignTextCase.Original, textDecoration = TextDecoration.None)
        }
        object Expanded : TypographyTokens {
            override val audioPlayerLabel = DesignTextStyle(fontFamily = "AntennaExtraCond", fontWeight = FontWeight.Bold, fontSize = 18.sp, lineHeight = 18.sp, letterSpacing = 0.sp, textCase = DesignTextCase.Original, textDecoration = TextDecoration.None)
        }
    }
}
