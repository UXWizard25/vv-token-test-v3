...
export const semanticTypographyFontsizeDisplayDisplay1fontsize = 72; // This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120
export const semanticTypographyFontsizeDisplayDisplay2fontsize = 42; // This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64
export const semanticTypographyFontsizeDisplayDisplay3fontsize = 32; // This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40
...
export const semanticTypographyFontsizeHeadlineHeadline1fontsize = 72; // This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100
export const semanticTypographyFontsizeHeadlineHeadline2fontsize = 48; // This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64
export const semanticTypographyFontsizeHeadlineHeadline3fontsize = 36; // This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40
...
export const semanticTypographyFontsizeKickerKicker1fontsize = 22; // Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size.
export const semanticTypographyFontsizeKickerKicker2fontsize = 22; // Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24
export const semanticTypographyFontsizeKickerKicker3fontsize = 18; // Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 16 - 16 - 18 - 20
...
export const semanticTypographyFontsizeSubheadlineSubheadline1fontsize = 32; // This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36
...
export const semanticTypographyLineheightTitleTitle2lineheight = 19.8; // html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg)
export const semanticTypographyLineheightQuoteQuotelineheight = 18; // This variable is used in the quote text style line height parameter.
...
export const componentArticleArticlekickerfontsize = 22; // This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30
export const componentArticleArticleheadlinefontsize = 72; // 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG
...
export const componentTeaserAteaserAteaserkickerfontsize = 22; // 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable
export const componentTeaserAteaserAteaserkickerlineheight = 22;
export const componentTeaserAteaserAteaserheadlinefontsize = 48; // This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64
...
export const componentTeaserMqteaserMqteaserheadlinefontsize = 36; // XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40
...
export const componentTeaserQteaserQuadheadlinefontsize = 72; // This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100
