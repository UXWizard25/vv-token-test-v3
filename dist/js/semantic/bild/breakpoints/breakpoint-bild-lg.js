...
export const semanticTypographyFontsizeCalloutCallout1fontsize = 22; // This token is used for the font size parameter of the callout text style. 18 - 18 - 22 - 22
export const semanticTypographyFontsizeDisplayDisplay1fontsize = 120; // This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120
export const semanticTypographyFontsizeDisplayDisplay2fontsize = 64; // This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64
export const semanticTypographyFontsizeDisplayDisplay3fontsize = 40; // This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40
export const semanticTypographyFontsizeFootnoteFootnote1fontsize = 18; // This token is used on the footnote text style font size parameter. 16 - 16 - 16 - 18
export const semanticTypographyFontsizeFootnoteFootnote2fontsize = 16; // This token is used in the font size parameter of the footnote2 text style. 12 - 12 - 12 - 16
export const semanticTypographyFontsizeHeadlineHeadline1fontsize = 100; // This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100
export const semanticTypographyFontsizeHeadlineHeadline2fontsize = 64; // This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64
export const semanticTypographyFontsizeHeadlineHeadline3fontsize = 40; // This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40
export const semanticTypographyFontsizeHeadlineHeadline4fontsize = 32; // This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32
export const semanticTypographyFontsizeKickerKicker1fontsize = 30; // Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size.
export const semanticTypographyFontsizeKickerKicker2fontsize = 24; // Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24
...
export const semanticTypographyFontsizeSubheadlineSubheadline1fontsize = 36; // This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36
...
export const semanticTypographyLineheightBodyBodylineheight = 32; // Figma's font line height currently does not allow for multipliers as is used on current website css var(--body-line-height)
...
export const semanticTypographyLineheightFootnoteFootnote1lineheight = 23;
export const semanticTypographyLineheightFootnoteFootnote2lineheight = 21;
export const semanticTypographyLineheightHeadlineHeadline1lineheight = 100;
export const semanticTypographyLineheightHeadlineHeadline2lineheight = 64;
export const semanticTypographyLineheightHeadlineHeadline3lineheight = 40;
export const semanticTypographyLineheightHeadlineHeadline4lineheight = 30;
export const semanticTypographyLineheightKickerKicker1lineheight = 30;
export const semanticTypographyLineheightKickerKicker2lineheight = 24;
export const semanticTypographyLineheightKickerKicker3lineheight = 20;
export const semanticTypographyLineheightKickerKicker4lineheight = 16;
...
export const semanticTypographyLineheightSubheadlineSubheadline1lineheight = 36;
export const semanticTypographyLineheightTitleTitle1lineheight = 28;
export const semanticTypographyLineheightTitleTitle2lineheight = 22; // html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg)
export const semanticTypographyLineheightQuoteQuotelineheight = 22; // This variable is used in the quote text style line height parameter.
...
export const componentAvatarAvatarlabelfontsize = 18; // This variable is used on avatar names in article pages. Bild: 16 - 16 - 16 - 18; SpoBi&Ads: 13 - 13 - 13 - 15
...
export const componentArticleArticlekickerfontsize = 30; // This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30
export const componentArticleArticleheadlinefontsize = 100; // 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG
export const componentArticleArticleimagecaptionfontsize = 18; // CSS --article-figure-meta-font-size 16-16-18-18
export const componentArticleArticleimagecaptionlineheight = 24.75; // this component level variable references the branding variables
...
export const componentArticleArticleimagesourcefontsize = 18; // NMT CSS --article-figure-meta-font-size
export const componentArticleArticleimagesourcelineheight = 23;
...
export const componentBreadcrumbBreadcrumbfontsize = 12; // 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices.
export const componentBreadcrumbBreadcrumblineheight = 12; // 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices.
...
export const componentTeaserAteaserAteaserkickerfontsize = 24; // 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable
export const componentTeaserAteaserAteaserkickerlineheight = 24;
export const componentTeaserAteaserAteaserheadlinefontsize = 64; // This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64
export const componentTeaserAteaserAteaserheadlinelineheight = 64;
...
export const componentTeaserMqteaserMqteaserheadlinefontsize = 40; // XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40
export const componentTeaserMqteaserMqteaserheadlinelineheight = 40;
...
export const componentTeaserQteaserQuadkickerfontsize = 24;
export const componentTeaserQteaserQuadheadlinefontsize = 100; // This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100
export const componentTeaserQteaserQuadheadlinelineheight = 100;
