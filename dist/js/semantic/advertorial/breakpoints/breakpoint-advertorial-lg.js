...
export const semanticTypographyFontsizeDisplayDisplay1fontsize = 116; // This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120
export const semanticTypographyFontsizeDisplayDisplay2fontsize = 62; // This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64
export const semanticTypographyFontsizeDisplayDisplay3fontsize = 39; // This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40
...
export const semanticTypographyFontsizeHeadlineHeadline1fontsize = 70; // This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100
...
export const semanticTypographyFontsizeHeadlineHeadline3fontsize = 32; // This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40
...
export const semanticTypographyFontsizeKickerKicker1fontsize = 25; // Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size.
export const semanticTypographyFontsizeKickerKicker2fontsize = 21; // Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24
...
export const semanticTypographyFontsizeSubheadlineSubheadline1fontsize = 28; // This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36
...
export const componentArticleArticlekickerfontsize = 25; // This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30
export const componentArticleArticleheadlinefontsize = 70; // 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG
export const componentArticleArticleimagecaptionfontsize = 16; // CSS --article-figure-meta-font-size 16-16-18-18
export const componentArticleArticleimagecaptionlineheight = 24; // this component level variable references the branding variables
...
export const componentTeaserAteaserAteaserkickerfontsize = 21; // 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable
...
export const componentTeaserMqteaserMqteaserheadlinefontsize = 32; // XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40
...
export const componentTeaserQteaserQuadheadlinefontsize = 70; // This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100
