...
export const semanticTypographyFontsizeDisplayDisplay1fontsize = 70; // This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120
export const semanticTypographyFontsizeDisplayDisplay2fontsize = 41; // This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64
export const semanticTypographyFontsizeDisplayDisplay3fontsize = 31; // This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40
...
export const semanticTypographyFontsizeHeadlineHeadline1fontsize = 54; // This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100
export const semanticTypographyFontsizeHeadlineHeadline2fontsize = 36; // This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64
export const semanticTypographyFontsizeHeadlineHeadline3fontsize = 26; // This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40
export const semanticTypographyFontsizeHeadlineHeadline4fontsize = 20; // This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32
...
export const semanticTypographyLineheightFootnoteFootnote1lineheight = 16.9;
export const semanticTypographyLineheightFootnoteFootnote2lineheight = 13;
export const semanticTypographyLineheightHeadlineHeadline1lineheight = 56.7;
export const semanticTypographyLineheightHeadlineHeadline2lineheight = 39.6;
export const semanticTypographyLineheightHeadlineHeadline3lineheight = 28.6;
export const semanticTypographyLineheightHeadlineHeadline4lineheight = 19.8;
...
export const semanticTypographyLineheightTitleTitle2lineheight = 19.2; // html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg)
...
export const componentArticleArticleheadlinefontsize = 54; // 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG
...
export const componentTeaserAteaserAteaserkickerfontsize = 18; // 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable
export const componentTeaserAteaserAteaserkickerlineheight = 18;
export const componentTeaserAteaserAteaserheadlinefontsize = 36; // This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64
export const componentTeaserAteaserAteaserheadlinelineheight = 39.6;
...
export const componentTeaserMqteaserMqteaserheadlinefontsize = 26; // XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40
export const componentTeaserMqteaserMqteaserheadlinelineheight = 28.6;
...
export const componentTeaserQteaserQuadheadlinefontsize = 54; // This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100
export const componentTeaserQteaserQuadheadlinelineheight = 56.7;
