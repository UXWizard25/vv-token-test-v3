 ...
 * Generiert am: 2025-11-24T20:37:01.765Z
...
export const articleHeadlineFontSize = "54px";
...
export const aTeaserKickerFontSize = "18px";
/** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
export const aTeaserHeadlineFontSize = "36px";
export const aTeaserKickerLineHeight = "18px";
export const aTeaserHeadlineLineHeight = "39.599998474121094px";
...
export const mQteaserHeadlineFontSize = "26px";
export const mQteaserHeadlineFontWeight = "700";
export const mQteaserHeadlineLineHeight = "28.600000381469727px";
...
export const quadHeadlineFontSize = "54px";
export const quadKickerFontSize = "18px";
export const quadHeadlineLineHeight = "56.70000076293945px";
...
export const headline1LineHeight = "56.70000076293945px";
export const headline2LineHeight = "39.599998474121094px";
export const headline3LineHeight = "28.600000381469727px";
export const headline4LineHeight = "19.799999237060547px";
...
export const title2LineHeight = "19.200000762939453px";
