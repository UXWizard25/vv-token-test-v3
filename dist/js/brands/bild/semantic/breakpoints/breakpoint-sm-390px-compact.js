 ...
 * Generiert am: 2025-11-24T21:42:41.338Z
...
export const dsysDocsWidthSize = "750px";
...
export const mainContentStageSize = "750px";
...
export const mQteaserHeadlineFontSize = "22px";
export const mQteaserHeadlineFontWeight = "600";
export const mQteaserHeadlineLineHeight = "22px";
...
export const aTeaserHeadlineFontSize = "28px";
export const aTeaserKickerLineHeight = "16px";
export const aTeaserHeadlineLineHeight = "28px";
...
export const quadHeadlineFontSize = "48px";
export const quadKickerFontSize = "18px";
export const quadHeadlineLineHeight = "48px";
...
/** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
export const appsTabsLabelFontSize = "12px";
/** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
...
export const breakpointMinWidthSize = "390px";
...
export const breakpointMaxWidthSize = "599px";
...
export const canvasHeightSizeWeb = "844px";
/** Common viewport width size based on the selected breakpoint.
Apply this token to the main frame of page layouts. */
export const canvasWidthSizeWeb = "390px";
/** Common viewport width size based on the selected breakpoint.
Apply this token to the main frame of page layouts. */
export const canvasWidthSizeApp = "390px";
/** Common viewport height size based on the selected mode.
Apply this token to the main frame of page layouts to simulate realistic vertical space. */
export const canvasHeightSizeApp = "844px";
...
export const kicker1FontSize = "18px";
...
export const kicker2FontSize = "18px";
...
export const subheadline1FontSize = "24px";
...
export const kicker2LineHeight = "19.799999237060547px";
export const kicker1LineHeight = "19.799999237060547px";
