 ...
 * Generiert am: 2025-11-25T09:42:55.233Z
...
export const mQteaserHeadlineFontSize = "40px";
export const mQteaserHeadlineFontWeight = "700";
export const mQteaserHeadlineLineHeight = "40px";
...
export const aTeaserKickerFontSize = "24px";
/** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
export const aTeaserHeadlineFontSize = "64px";
export const aTeaserKickerLineHeight = "24px";
export const aTeaserHeadlineLineHeight = "64px";
...
export const quadHeadlineFontSize = "100px";
export const quadKickerFontSize = "24px";
export const quadHeadlineLineHeight = "100px";
...
export const avatarLabelFontSize = "18px";
...
export const breadcrumbFontSize = "12px";
...
/** 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices. */
export const breadcrumbLineHeight = "12px";
...
export const title1FontSize = "28px";
...
export const kicker1FontSize = "30px";
...
export const kicker2FontSize = "24px";
...
export const kicker3FontSize = "20px";
...
export const subheadline1FontSize = "36px";
...
export const bodyLineHeight = "32px";

// Semantic - Typography - LineHeight - Kicker
export const kicker4LineHeight = "16px";
export const kicker3LineHeight = "20px";
export const kicker2LineHeight = "24px";
export const kicker1LineHeight = "30px";
...
export const label1ResponsiveLineHeight = "17px";
