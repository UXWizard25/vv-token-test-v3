...
class BreakpointXs320px {
    ...
    static const mQteaserHeadlineFontSize = "16px";
    static const mQteaserHeadlineFontWeight = 600;
    static const mQteaserHeadlineLineHeight = "18.399999618530273px";
    ...
    static const aTeaserKickerFontSize = "14px";
    /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    static const aTeaserHeadlineFontSize = "24px";
    static const aTeaserKickerLineHeight = "14px";
    static const aTeaserHeadlineLineHeight = "24px";
    ...
    static const quadHeadlineFontSize = "36px";
    static const quadKickerFontSize = "16px";
    static const quadHeadlineLineHeight = "37.79999923706055px";
    ...
    /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    static const appsTabsLabelFontSize = "11px";
    /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
...
Apply this token to the main frame of page layouts to simulate realistic minimum widths across responsive viewports. */
    static const breakpointMinWidthSize = "320px";
...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    static const breakpointMaxWidthSize = "389px";
...
Apply this token to the main frame of page layouts to simulate realistic vertical space. */
    static const canvasHeightSizeWeb = "568px";
    /** Common viewport width size based on the selected breakpoint.
Apply this token to the main frame of page layouts. */
    static const canvasWidthSizeWeb = "320px";
    /** Common viewport width size based on the selected breakpoint.
Apply this token to the main frame of page layouts. */
    static const canvasWidthSizeApp = "320px";
    /** Common viewport height size based on the selected mode.
Apply this token to the main frame of page layouts to simulate realistic vertical space. */
    static const canvasHeightSizeApp = "568px";
    ...
    static const title2FontSize = "14px";
    ...
    static const callout1FontSize = "16px";
    ...
    static const kicker1FontSize = "16px";
    ...
    static const kicker4FontSize = "12px";
    ...
    static const kicker4LineHeight = "13.199999809265137px";
    static const kicker3LineHeight = "15.399999618530273px";
    static const kicker2LineHeight = "17.600000381469727px";
    static const kicker1LineHeight = "17.600000381469727px";
    ...
    static const title2LineHeight = "16.799999237060547px";
    ...
    static const headline1LineHeight = "37.79999923706055px";
    static const headline2LineHeight = "33px";
    static const headline3LineHeight = "26.399999618530273px";
    static const headline4LineHeight = "18.399999618530273px";

    // Semantic - Typography - LineHeight - Callout
    static const calloutLineHeight = "20.799999237060547px";
