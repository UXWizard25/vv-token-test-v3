...
class BreakpointLg1024pxRegular {
    ...
    static const componentArticleArticleHeadlineFontSize = 1280.00; /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    static const componentArticleArticleImageCaptionFontSize = 240.00; /** CSS --article-figure-meta-font-size 16-16-18-18 */
    ...
    static const componentArticleArticleImageSourceFontSize = 240.00; /** NMT CSS --article-figure-meta-font-size */
    ...
    static const componentArticleArticleKickerFontSize = 512.00; /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    static const componentBreadcrumbBreadcrumbFontSize = 176.00; /** 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices. */
    static const componentBreadcrumbBreadcrumbFontWeight = 400;
    static const componentBreadcrumbBreadcrumbInlineSpace = 0.00;
    static const componentBreadcrumbBreadcrumbLineHeight = 176.00; /** 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices. */
    ...
    static const componentTeaserATeaserATeaserHeadlineFontSize = 800.00; /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    static const componentTeaserATeaserATeaserHeadlineLineHeight = 921.60;
    ...
    static const componentTeaserMQTeaserMQTeaserHeadlineFontSize = 544.00; /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    static const componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700;
    static const componentTeaserMQTeaserMQTeaserHeadlineLineHeight = 625.60;
    ...
    static const componentTeaserQTeaserQuadHeadlineFontSize = 1280.00; /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    static const componentTeaserQTeaserQuadHeadlineLineHeight = 1408.00;
...
semanticLayoutCanvasWidthSizeWeb = 16384.00;
    ...
    static const semanticTypographyFontSizeDisplayDisplay1FontSize = 1824.00; /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    static const semanticTypographyFontSizeDisplayDisplay2FontSize = 976.00; /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    static const semanticTypographyFontSizeDisplayDisplay3FontSize = 608.00; /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    static const semanticTypographyFontSizeHeadlineHeadline1FontSize = 1280.00; /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    static const semanticTypographyFontSizeHeadlineHeadline2FontSize = 800.00; /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    static const semanticTypographyFontSizeHeadlineHeadline3FontSize = 544.00; /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    ...
    static const semanticTypographyFontSizeKickerKicker1FontSize = 512.00; /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    ...
    static const semanticTypographyFontSizeKickerKicker3FontSize = 352.00; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 16 - 16 - 18 - 20 */
    static const semanticTypographyFontSizeKickerKicker4FontSize = 288.00; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 14 - 14 - 16 - 16 */
    ...
    static const semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 416.00; /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    static const semanticTypographyFontSizeTitleTitle1FontSize = 480.00; /** 22 - 22 - 22 - 28 -- html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
    ...
    static const semanticTypographyLineHeightFootnoteFootnote1LineHeight = 304.00;
    static const semanticTypographyLineHeightFootnoteFootnote2LineHeight = 272.48;
    static const semanticTypographyLineHeightHeadlineHeadline1LineHeight = 1408.00;
    static const semanticTypographyLineHeightHeadlineHeadline2LineHeight = 921.60;
    static const semanticTypographyLineHeightHeadlineHeadline3LineHeight = 625.60;
    static const semanticTypographyLineHeightHeadlineHeadline4LineHeight = 478.40;
    static const semanticTypographyLineHeightKickerKicker1LineHeight = 563.20;
    static const semanticTypographyLineHeightKickerKicker2LineHeight = 457.60;
    static const semanticTypographyLineHeightKickerKicker3LineHeight = 387.20;
    static const semanticTypographyLineHeightKickerKicker4LineHeight = 316.80;
    ...
    static const semanticTypographyLineHeightLabelLabel1ResponsiveLineHeight = 326.40;
    ...
    static const semanticTypographyLineHeightQuoteQuoteLineHeight = 416.00; /** This variable is used in the quote text style line height parameter. */
    static const semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = 540.80;
    static const semanticTypographyLineHeightTitleTitle1LineHeight = 528.00;
    static const semanticTypographyLineHeightTitleTitle2LineHeight = 416.00; /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
