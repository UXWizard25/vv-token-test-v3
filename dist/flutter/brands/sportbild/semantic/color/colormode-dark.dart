...
class ColormodeDark {
    ...
    static const avatarLabelColor = Color(0xFFFFFFFF);
    /** 09-2025 css --article-author-name-color */
    ...
    static const breadcrumbTextColorIdle = Color(0xFFF2F4F5);
    ...
    static const breadcrumbTextColorHover = Color(0xFFFFFFFF);

    // Component - BreakingNews
    static const breakingNewsTitleSurfaceColor = Color(0xFFFD8227);
    static const breakingNewsSurfaceColor = Color(0xFFE9ECEF);
    ...
    // Component - Button
    static const buttonLiveTickerLoadNewSurfaceColor = Color(0xFF232629);
    static const buttonLiveTickerLoadNewLabelColor = Color(0xFFF2F4F5);

    // Component - Button - Ghost
    static const buttonGhostBgColorHover = Color(0x80ced4da);
    ...
    static const buttonPrimaryNeutralBgColorIdle = Color(0xFFFFFFFF);
    static const buttonPrimaryNeutralBgColorHover = Color(0xFFE9ECEF);

    // Component - Button - Secondary
    static const buttonSecondaryBgColorHover = Color(0x80ced4da);
    static const buttonSecondaryLabelColor = Color(0xFFE9ECEF);
    static const buttonSecondaryBgColorIdle = Color(0xFF4B525A);

    // Component - Button - Tertiary
    static const buttonTertiaryLabelColor = Color(0xFFF2F4F5);
    static const buttonTertiaryBorderColorIdle = Color(0xFF4B525A);
    static const buttonTertiaryBorderColorHover = Color(0xFFFFFFFF);
    static const buttonTertiarySuccessBgColorHover = Color(0x80009b5a);
    static const buttonTertiarySuccessBorderColor = Color(0xFF18995C);

    // Component - Card
    static const cardSurfaceBgColor = Color(0xFF2C3138);

    // Component - Chips
    static const chipsBgColorHover = Color(0xFFCED4DA);
    static const chipsLabelColorHover = Color(0xFF232629);
    static const chipsBgColorActive = Color(0xFFFFFFFF);
    static const chipsBgColorIdle = Color(0xFF4B525A);
    static const chipsLabelColorIdle = Color(0xFFFFFFFF);

    // Component - Dropdown
    static const dropdownBgColorHover = Color(0xFF4B525A);
    static const dropdownBgColorIdle = Color(0xFF343C41);

    // Component - Empties
    static const emptiesBgColor = Color(0xFF343C41);
    static const emptiesLogoColor = Color(0xFF2C3138);

    // Component - Foldout
    static const foldoutLabelColorActive = Color(0xFFF2F4F5);
    static const foldoutLabelColorIdle = Color(0xFFCED4DA);

    // Component - Gallery
    static const appImageLightboxGalleryBgColor = Color(0xFF000000);

    // Component - Hey
    static const heyFavInputFieldSurfaceColor = Color(0xFF4B525A);
    static const heyTextColor = Color(0xFFE9ECEF);
    static const heyIconUtilColor = Color(0xFFFFFFFF);
    /** This is the most used color for separators across Bild products. */
    static const heySeparatorColor = Color(0xFF666B70);
    static const heyDrawerSurfaceColor = Color(0xFF343C41);

    // Component - InputField
    static const inputFieldBorderColorIdle = Color(0xFF8C9196);
    static const inputFieldBorderColorActive = Color(0xFFE9ECEF);
    static const inputFieldBorderColorDark = Color(0xFFCED4DA);
    static const inputFieldBorderColorDarkActive = Color(0xFFFFFFFF);
    ...
    // Component - Menu
    static const menuSurfaceColor = Color(0xFF232629);
    /** Used on a thin part at the top of header in navigation menu. */
    static const menuScrolledSurfaceGradientColor = Color(0xf2232629);
    static const menuLinkLaneSurfaceColor = Color(0xFF232629);
    static const menuLinkLaneLabelColor = Color(0xFF8C9196);
    static const menuLinkLaneLabelColorActive = Color(0xFFFFFFFF);
    static const appTopBarSurfaceColor = Color(0xFF343C41);
    static const appTopBarIconColor = Color(0xFF8C9196);
    static const appTopBarTextColorPrimary = Color(0xFFE9ECEF);
    static const appTobBarTabNavBottomBorder = Color(0xFF4B525A);
    static const appTobBarTabNavBottomBorderActive = Color(0xFFFFFFFF);

    // Component - MenuItem
    static const menuItemBorderColorActive = Color(0xFFFFFFFF);
    static const menuItemLabelColorPrimary = Color(0xFF8C9196);
    static const menuItemLabelColorPrimaryActive = Color(0xFFF2F4F5);
    ...
    static const paginationElementColorDefault = Color(0xFF8C9196);
    static const paginationElementColorActive = Color(0xFFFFFFFF);
    ...
    static const scrollBarTrackBgColor = Color(0x1affffff);
    ...
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    static const partnerLinksBorderColorActive = Color(0xFFE9ECEF);
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    static const partnerLinksBgColorIdle = Color(0xFF343C41);
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    static const partnerLinksBgColorActive = Color(0xFF8C9196);
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    static const partnerLinksContainerBorderColor = Color(0xFF4B525A);

    // Component - Selection
    /** Checkboxes and Radio buttons use this variable for their border. */
    static const selectionBorderColor = Color(0xFF8C9196);
    ...
    // Component - Subheader
    static const subheadersColor = Color(0xFFE9ECEF);

    // Component - Tab
    static const tabBgColorHover = Color(0xFF343C41);
    static const tabLabelColorActive = Color(0xFFF2F4F5);
    static const tabLabelColorDefault = Color(0xFFFFFFFF);
    static const appBottomTabBarBgColor = Color(0xFF343C41);
    ...
    // Component - TextLink
    static const textLinkColorSecondary = Color(0xFFCED4DA);
    static const textLinkColorSecondaryActive = Color(0xFFE9ECEF);
    static const textLinkColorPrimary = Color(0xFF8C9196);

    // Component - _DSysDoc
    /** This variable is only for use in Figma's Design System File. It is automating some of the content in documentation pages. */
    static const _DSysDocs_labelTextSurfaceColorPrimaryPrimitiveName = "BILD010";
    ...
    static const _DSysDocs_labelTextColorMode = "(Dark Mode)";
    ...
    static const accentColorPrimary = Color(0xFFFFFFFF);
    ...
    static const attentionColorExtraLow = Color(0xFF343C41);
...
Behavior: Dynamic — adjusts to maintain legibility in Light and Dark themes. */
    static const borderColorMediumContrast = Color(0xFF666B70);
...
Dynamic — light gray in Light mode, dark gray in Dark mode. */
    static const borderColorLowContrast = Color(0xFF4B525A);
...
Behavior: Dynamic — light surfaces use a darker neutral, dark surfaces a light neutral tone. */
    static const borderColorHighContrast = Color(0xFFFFFFFF);
...
Behavior: Constant — retains the same red warning tone in both Light and Dark modes. */
    ...
    static const borderColorPrimaryDisabled = Color(0xFF343C41);
    /** Used for secondary component borders in a disabled state (e.g., secondary buttons, inactive input outlines). */
    static const borderColorSecondaryDisabled = Color(0xFF4B525A);
    ...
    static const coreColorSecondary = Color(0xFF232629);
    /** Represents tertiary brand accents. This variable changes across Light and Dark Mode. */
    static const coreColorTertiary = Color(0xFFFFFFFF);
    ...
    static const coreColorTertiaryVvPipeTEST = Color(0xFFB0D1F3);
    /** this is a test for the token pipeline */
...
Behavior: Dynamic — dark text in Light mode, light text in Dark mode. */
    static const headlineColorPrimary = Color(0xFFFFFFFF);
...
Behavior: Constant — remains semi-transparent black across both modes. */
    ...
    static const iconColorPrimary = Color(0xFF8C9196);
...
Behavior: Dynamic — switches between light and dark. */
    static const iconColorInverse = Color(0xFF4B525A);
...
Behavior: Dynamic — dark neutral in Light mode, light neutral in Dark mode. */
    static const labelColorPrimary = Color(0xFFE9ECEF);
...
Behavior: Dynamic — adapts between mid-grays for Light and Dark surfaces. */
    static const labelColorSecondary = Color(0xFFCED4DA);
...
Behavior: Dynamic — lighter gray in Light mode, darker neutral in Dark mode. */
    static const labelColorDisabled = Color(0xFF4B525A);
...
Behavior: Dynamic — switches between light and dark. */
    static const labelColorPrimaryInverse = Color(0xFF232629);
...
Behavior: Dynamic — light gray in Light mode and bright gray in Dark mode to maintain perceptual balance. */
    static const colorSecondaryActive = Color(0xFFF2F4F5);
...
Behavior: Dynamic — adapts neutral tones based on theme brightness. */
    static const colorSecondaryDisabled = Color(0xFF4B525A);
...
Behavior: Dynamic — slightly lighter in Light mode and darker in Dark mode to remain visually accessible. */
    static const colorPrimaryDisabled = Color(0xFF343C41);
...
Behavior: Dynamic — switches between bright and dark tones depending on the background. */
    static const colorSecondaryActiveInverse = Color(0xFF232629);
...
Behavior: Dynamic — adjusts between gray tones for Light and Dark mode consistency. */
    static const colorTertiaryDisabled = Color(0xFF666B70);
...
Behavior: Dynamic — adapts between light and dark surface tokens to maintain legibility and hierarchy. */
    static const surfaceColorPrimary = Color(0xFF232629);
...
Behavior: Dynamic — adapts brightness level based on mode for appropriate depth contrast. */
    static const surfaceColorSecondary = Color(0xFF2C3138);
...
Behavior: Dynamic — switches between dark and light values depending on mode. */
    static const surfaceColorPrimaryInverse = Color(0xFFFFFFFF);
...
Behavior: Constant — identical across Light and Dark mode. */
    ...
    static const surfaceColorQuartenary = Color(0xFF4B525A);
...
Behavior: Dynamic — switches between light and dark tertiary tones. */
    static const surfaceColorTertiary = Color(0xFF343C41);
    /** Represents tertiary-level gradient background.
Currently used on skeletons. */
    static const surfaceColorTertiaryGradientStop = Color(0x00343c41);
...
Behavior: Dynamic — swaps values between modes for contrast preservation. */
    static const surfaceColorTertiaryInverse = Color(0xFFE9ECEF);
    ...
    static const surfaceColorPrimaryGradientStop = Color(0x00232629);
...
Behavior: Dynamic — adapts to mode brightness for smooth gradient transitions. */
    static const surfaceColorSecondaryGradientStop = Color(0x002c3138);
...
Behavior: Dynamic — inverts between dark and light tones depending on mode. */
    static const surfaceColorQuartenaryInverse = Color(0xFFCED4DA);
...
Behavior: Dynamic — switches between dark text on light backgrounds and light text on dark backgrounds. */
    static const textColorPrimary = Color(0xFFE9ECEF);
...
Behavior: Dynamic — adjusts between mid-gray in Light mode and lighter gray in Dark mode. */
    static const textColorMuted = Color(0xFFCED4DA);
...
Behavior: Dynamic — alternates between light and dark mode. */
    static const textColorPrimaryInverse = Color(0xFF232629);
