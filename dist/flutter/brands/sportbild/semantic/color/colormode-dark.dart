...
class ColormodeDark {
    ...
    static const componentAlertAlertSurfaceColor = Color(0xFF343C41); /** On marketing offer surfaces this variable is usually not used. The alertSurfaceConstant variables should be used. This token changes color between light and dark modes. L:100 / D:025 */
    ...
    static const componentBreadcrumbBreadcrumbTextColorIdle = Color(0xFFF2F4F5); /** Use this token on breadcrumbs that are in their default idle state. This token changes color between light and dark modes. L:035 / D:096 */
    static const componentBreakingNewsBreakingNewsBottomTitleTextColor = Color(0xFF1C1C1C);
    static const componentBreakingNewsBreakingNewsSurfaceColor = Color(0xFFE9ECEF);
    static const componentBreakingNewsBreakingNewsTextContentColor = Color(0xFF232629);
    ...
    static const componentButtonButtonLiveTickerLoadNewLabelColor = Color(0xFFF2F4F5);
    static const componentButtonButtonLiveTickerLoadNewSurfaceColor = Color(0xFF232629);
    static const componentButtonGhostButtonGhostBgColorHover = Color(0x80CED4DA);
    ...
    static const componentButtonPrimaryButtonPrimaryNeutralBgColorHover = Color(0xFFE9ECEF);
    ...
    static const componentButtonSecondaryButtonSecondaryBgColorHover = Color(0x80CED4DA);
    static const componentButtonSecondaryButtonSecondaryBgColorIdle = Color(0xFF4B525A);
    static const componentButtonSecondaryButtonSecondaryLabelColor = Color(0xFFE9ECEF);
    static const componentButtonTertiaryButtonTertiaryBorderColorHover = Color(0xFFFFFFFF);
    static const componentButtonTertiaryButtonTertiaryBorderColorIdle = Color(0xFF4B525A);
    static const componentButtonTertiaryButtonTertiaryLabelColor = Color(0xFFF2F4F5);
    static const componentButtonTertiaryButtonTertiarySuccessBgColorHover = Color(0x80009B5A);
    static const componentButtonTertiaryButtonTertiarySuccessBorderColor = Color(0xFF18995C);
    static const componentCardCardSurfaceBgColor = Color(0xFF2C3138);
    static const componentChipsChipsBgColorActive = Color(0xFFFFFFFF);
    static const componentChipsChipsBgColorHover = Color(0xFFCED4DA);
    static const componentChipsChipsBgColorIdle = Color(0xFF4B525A);
    static const componentChipsChipsLabelColorHover = Color(0xFF232629);
    ...
    static const componentDropdownDropdownBgColorHover = Color(0xFF4B525A);
    static const componentDropdownDropdownBgColorIdle = Color(0xFF343C41);
    static const componentEmptiesEmptiesBgColor = Color(0xFF343C41);
    static const componentEmptiesEmptiesLogoColor = Color(0xFF2C3138);
    static const componentFoldoutFoldoutLabelColorActive = Color(0xFFF2F4F5);
    static const componentFoldoutFoldoutLabelColorIdle = Color(0xFFCED4DA);
    static const componentGalleryAppImageLightboxGalleryBgColor = Color(0xFF000000);
    static const componentHeyHeyDrawerSurfaceColor = Color(0xFF343C41);
    static const componentHeyHeyFavInputFieldSurfaceColor = Color(0xFF4B525A);
    ...
    static const componentHeyHeyTextColor = Color(0xFFE9ECEF);
    ...
    static const componentInputFieldInputFieldBorderColorActive = Color(0xFFE9ECEF);
    static const componentInputFieldInputFieldBorderColorDark = Color(0xFFCED4DA);
    ...
    static const componentMenuAppTobBarTabNavBottomBorder = Color(0xFF4B525A);
    ...
    static const componentMenuAppTopBarSurfaceColor = Color(0xFF343C41);
    static const componentMenuAppTopBarTextColorPrimary = Color(0xFFE9ECEF);
    ...
    static const componentMenuItemMenuItemLabelColorPrimaryActive = Color(0xFFF2F4F5);
    ...
    static const componentMenuMenuLinkLaneSurfaceColor = Color(0xFF232629);
    static const componentMenuMenuScrolledSurfaceGradientColor = Color(0xF2232629); /** Used on a thin part at the top of header in navigation menu. */
    static const componentMenuMenuSurfaceColor = Color(0xFF232629);
    ...
    static const componentPartnerLinksPartnerLinksBgColorIdle = Color(0xFF343C41); /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    static const componentPartnerLinksPartnerLinksBorderColorActive = Color(0xFFE9ECEF); /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    ...
    static const componentPartnerLinksPartnerLinksContainerBorderColor = Color(0xFF4B525A); /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    ...
    static const componentSubheaderSubheadersColor = Color(0xFFE9ECEF);
    static const componentTabAppBottomTabBarBgColor = Color(0xFF343C41);
    static const componentTabTabBgColorHover = Color(0xFF343C41);
    static const componentTabTabLabelColorActive = Color(0xFFF2F4F5);
    ...
    static const componentTextLinkTextLinkColorSecondary = Color(0xFFCED4DA);
    static const componentTextLinkTextLinkColorSecondaryActive = Color(0xFFE9ECEF);
    ...
    static const semanticAttentionAttentionColorExtraLow = Color(0xFF343C41); /** Very low-contrast background tone used for information or system-neutral surfaces, often for tooltips or quiet information highlights. Dynamic — light neutral in Light mode and dark neutral in Dark mode. */
 ...
 */
semanticBorderBorderColorLowContrast = Color(0xFF4B525A);
...
semanticBorderBorderColorMediumContrast = Color(0xFF666B70);
    static const semanticBorderBorderColorPrimaryDisabled = Color(0xFF343C41); /** Applied to disabled states of primary elements (e.g., buttons, inputs) to visually reduce emphasis and indicate inactivity. */
    static const semanticBorderBorderColorSecondaryDisabled = Color(0xFF4B525A); /** Used for secondary component borders in a disabled state (e.g., secondary buttons, inactive input outlines). */
    static const /**
...
semanticBorderBorderColorWarning = Color(0xFFDD0000);
    ...
    static const semanticCoreCoreColorSecondary = Color(0xFF232629); /** Defines the secondary brand tone. This variable changes across Light and Dark Mode. */
    ...
    static const semanticCoreGolianiTestColor = Color(0xFF031A31); /** this is a test for the token pipeline */
 ...
 */
semanticIconIconColorInverse = Color(0xFF4B525A);
 ...
 */
semanticLabelLabelColorDisabled = Color(0xFF4B525A);
    static const /**
 ...
 */
semanticLabelLabelColorPrimary = Color(0xFFE9ECEF);
    static const /**
 ...
 * Behavior: Dynamic — switches between light and dark.
 */
semanticLabelLabelColorPrimaryInverse = Color(0xFF232629);
    static const /**
 ...
 */
semanticLabelLabelColorSecondary = Color(0xFFCED4DA);
    static const /**
 ...
 */
semanticStateColorPrimaryDisabled = Color(0xFF343C41);
    static const /**
 ...
 */
semanticStateColorSecondaryActive = Color(0xFFF2F4F5);
    static const /**
 ...
 */
semanticStateColorSecondaryActiveInverse = Color(0xFF232629);
    static const /**
 ...
 */
semanticStateColorSecondaryDisabled = Color(0xFF4B525A);
    static const /**
 ...
 */
semanticSurfaceSurfaceColorPrimary = Color(0xFF232629);
    static const /**
...
semanticSurfaceSurfaceColorPrimaryInverse = Color(0xFFFFFFFF);
    static const semanticSurfaceSurfaceColorQuartenary = Color(0xFF4B525A); /** HIghtest elevation surface color, typically used for grouping or background accents to differentiate themselves from all previous surface color options. Uses corresponding light/dark tones for consistent layering. */
    static const /**
 ...
 */
semanticSurfaceSurfaceColorQuartenaryInverse = Color(0xFFCED4DA);
    static const /**
 ...
 */
semanticSurfaceSurfaceColorSecondary = Color(0xFF2C3138);
    static const /**
 ...
 */
semanticSurfaceSurfaceColorSecondaryGradientStop = Color(0x002C3138);
    static const /**
 ...
 */
semanticSurfaceSurfaceColorTertiary = Color(0xFF343C41);
    static const /**
 * Represents tertiary-level gradient background.
 * Currently used on skeletons.
 */
semanticSurfaceSurfaceColorTertiaryGradientStop = Color(0x00343C41);
    static const /**
 ...
 */
semanticSurfaceSurfaceColorTertiaryInverse = Color(0xFFE9ECEF);
 ...
 */
semanticTextTextColorMuted = Color(0xFFCED4DA);
    static const /**
 ...
 */
semanticTextTextColorPrimary = Color(0xFFE9ECEF);
    static const /**
 ...
 */
semanticTextTextColorPrimaryInverse = Color(0xFF232629);
    static const /**
