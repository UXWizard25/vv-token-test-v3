...
class BreakpointMd600px {
    ...
    static const articleImageSourceLineHeight = "21px";
    ...
    static const avatarLabelFontSize = "16px";
    ...
    static const aTeaserKickerFontSize = "22px";
    ...
    static const aTeaserKickerLineHeight = "22px";
    static const aTeaserHeadlineLineHeight = "48px";
    ...
    static const mQTeaserHeadlineFontSize = "36px";
    static const mQTeaserHeadlineFontWeight = 700;
    static const mQTeaserHeadlineLineHeight = "36px";
    ...
    static const quadHeadlineFontSize = "72px";
    static const quadKickerFontSize = "22px";
    static const quadHeadlineLineHeight = "72px";
...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    ...
    static const headline1FontSize = "72px";
    ...
    static const headline3FontSize = "36px";
    ...
    static const kicker1FontSize = "22px";
    ...
    static const kicker2FontSize = "22px";
    ...
    static const kicker3FontSize = "18px";
    ...
    static const subheadline1FontSize = "32px";
    ...
    static const footnote2LineHeight = "15.800000190734863px";

    // Semantic - Typography - LineHeight - Headline
    static const headline1LineHeight = "72px";
    static const headline2LineHeight = "48px";
    static const headline3LineHeight = "36px";
    ...
    static const kicker3LineHeight = "18px";
    static const kicker2LineHeight = "22px";
    ...
    static const quoteLineHeight = "18px";

    // Semantic - Typography - LineHeight - Subheadline
    static const subheadline1LineHeight = "32px";
    ...
    static const title2LineHeight = "19.799999237060547px";
