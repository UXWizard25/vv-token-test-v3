...
class BreakpointMd600px {
    ...
    static const componentArticleArticleHeadlineFontSize = 1152.00; /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    static const componentArticleArticleImageSourceLineHeight = 336.00;
    ...
    static const componentArticleArticleKickerFontSize = 352.00; /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    static const componentAvatarAvatarLabelFontSize = 256.00; /** This variable is used on avatar names in article pages. Bild: 16 - 16 - 16 - 18; SpoBi&Ads: 13 - 13 - 13 - 15 */
    ...
    static const componentTeaserATeaserATeaserHeadlineLineHeight = 768.00;
    static const componentTeaserATeaserATeaserKickerFontSize = 352.00; /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    static const componentTeaserATeaserATeaserKickerLineHeight = 352.00;
    ...
    static const componentTeaserMQTeaserMQTeaserHeadlineFontSize = 576.00; /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    static const componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700;
    static const componentTeaserMQTeaserMQTeaserHeadlineLineHeight = 576.00;
    ...
    static const componentTeaserQTeaserQuadHeadlineFontSize = 1152.00; /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    static const componentTeaserQTeaserQuadHeadlineLineHeight = 1152.00;
    static const componentTeaserQTeaserQuadKickerFontSize = 352.00;
...
semanticLayoutCanvasWidthSizeWeb = 9600.00;
    ...
    static const semanticTypographyFontSizeDisplayDisplay1FontSize = 1152.00; /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    static const semanticTypographyFontSizeDisplayDisplay2FontSize = 672.00; /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    static const semanticTypographyFontSizeDisplayDisplay3FontSize = 512.00; /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    static const semanticTypographyFontSizeFootnoteFootnote1FontSize = 256.00; /** This token is used on the footnote text style font size parameter. 16 - 16 - 16 - 18 */
    static const semanticTypographyFontSizeFootnoteFootnote2FontSize = 192.00; /** This token is used in the font size parameter of the footnote2 text style. 12 - 12 - 12 - 16 */
    static const semanticTypographyFontSizeHeadlineHeadline1FontSize = 1152.00; /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    ...
    static const semanticTypographyFontSizeHeadlineHeadline3FontSize = 576.00; /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    ...
    static const semanticTypographyFontSizeKickerKicker1FontSize = 352.00; /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    static const semanticTypographyFontSizeKickerKicker2FontSize = 352.00; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24 */
    static const semanticTypographyFontSizeKickerKicker3FontSize = 288.00; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 16 - 16 - 18 - 20 */
    ...
    static const semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 512.00; /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    static const semanticTypographyLineHeightBodyBodyLineHeight = 448.00; /** Figma's font line height currently does not allow for multipliers as is used on current website css var(--body-line-height) */
    ...
    static const semanticTypographyLineHeightFootnoteFootnote1LineHeight = 336.00;
    static const semanticTypographyLineHeightFootnoteFootnote2LineHeight = 252.80;
    static const semanticTypographyLineHeightHeadlineHeadline1LineHeight = 1152.00;
    static const semanticTypographyLineHeightHeadlineHeadline2LineHeight = 768.00;
    static const semanticTypographyLineHeightHeadlineHeadline3LineHeight = 576.00;
    static const semanticTypographyLineHeightHeadlineHeadline4LineHeight = 352.00;
    static const semanticTypographyLineHeightKickerKicker1LineHeight = 352.00;
    static const semanticTypographyLineHeightKickerKicker2LineHeight = 352.00;
    static const semanticTypographyLineHeightKickerKicker3LineHeight = 288.00;
    ...
    static const semanticTypographyLineHeightQuoteQuoteLineHeight = 288.00; /** This variable is used in the quote text style line height parameter. */
    static const semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = 512.00;
    static const semanticTypographyLineHeightTitleTitle1LineHeight = 352.00;
    static const semanticTypographyLineHeightTitleTitle2LineHeight = 316.80; /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
