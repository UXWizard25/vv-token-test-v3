...
class BreakpointLg1024pxRegular {
    ...
    static const articleContentStackSpace = "32px";
    ...
    static const articleHeadingsStackSpace = "16px";
    static const articleImageLandscapeInlineSpace = "16px";
    ...
    static const articleMetaFontFamily = "Gotham";
    ...
    static const articleMetaFontSize = "16px";
    ...
    static const articleContentInlineSpace = "162px";
    ...
    static const articleImagePortaitInlineSpace = "162px";
    static const articleImageContainerStackSpace = "16px";
    static const articleInfoboxInlineSpace = "32px";
    static const articleInfoboxStackSpace = "32px";
    ...
    static const avatarLabelLineHeight = "23px";
    ...
    static const breadcrumbFontSize = "12px";
    ...
    static const breadcrumbInlineSpace = "0px";
    /** 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices. */
    static const breadcrumbLineHeight = "12px";
    static const breadcrumbFontWeight = 700;
    static const breadcrumbStackSpace = "16px";
    ...
    static const breakingNewsBadgeInlineSpace = "26px";
    ...
    static const partnerLinkButtonLabelFontSize = "18px";
    ...
    // Component - Cards
    static const searchResultCardImageWidthSize = "260px";
    ...
    static const standardTeaserGalleryTeaserWidthWeb = "300px";
    static const standardTeaserGalleryTeaserWidthApp = "464px";
    ...
    static const chipsFontSize = "18px";
    ...
    static const dropDownItemInlineSpace = "16px";
    ...
    static const infoElementTeaserBadgeHeightSize = "24px";
    static const infoElementTeaserImageHeightSize = "133px";
    static const infoElementTeaserImageWidthSize = "236px";
    static const infoElementTeaserBadgeMarginSpace = "8px";
    ...
    static const heyInputContainerInlineSpace = "16px";
    ...
    static const liveTickerSliderItemWidthMaxSize = "537px";
    ...
    static const vidPlayerBottomBarGapSpace = "16px";
    ...
    static const vidPlayerTimecodeFontSize = "18px";
    static const vidPlayerTimecodeContainerMinWidthSize = "58px";
    static const vidPlayerProgressBarContainerHeightSize = "42px";
    ...
    static const menuLogoDefaultSize = "148px";
    static const menuLogoScrolledSize = "56px";
    static const menuSpecialNaviItemHeightSize = "56px";
    static const subNavBarHeightSize = "42px";
    static const menuUtilityLinksContainerHeightSize = "100px";
    static const menuTopStackSpace = "12px";
    static const menuLeftInlineSpace = "16px";
    static const menuUtilityLinksGapSpace = "32px";
    static const menuRightInlineSpace = "16px";
    static const menuBottomStackSpace = "0px";
    static const menuUtilityLinksDividerHeightSize = "48px";
    ...
    static const menuShadowVisibility = Color(0x00000000);
    ...
    static const heyInputShadowVisibility = Color(0x1a000000);
    ...
    static const newsTickerTimeFontSize = "18px";
    ...
    static const newsTickerTimeLineHeight = "23.399999618530273px";
    static const newsTickerContentStackSpace = "4px";
    static const newsTickerKickerInnerStackSpace = "2px";
    static const newsTickerTitlesInlineSpace = "30px";
    static const newsTickerBadgesInlineSpace = "16px";
    ...
    static const newsTickerRedDotSize = "16px";
    static const newsTickerEntriesLeftInlineSpace = "22px";
    static const newsTickerLineInlineSpace = "8px";
    ...
    // Component - Quotes
    static const quoteContainerInlineSpace = "28px";
    static const quoteContainerStackSpace = "32px";
    static const quoteQuotationMarksFontSize = "36px";
    ...
    static const sectionTitleHeightSize = "40px";
    ...
    static const sectionTitle&ArrowInlineSpaceActive = "8px";
    ...
    static const specialNaviInlineSpace = "32px";
    ...
    // Component - Table
    static const tableColumnWidthSize1x = "140px";
    static const tableColumnWidthSize2x = "220px";
    static const tableColumnWidthSize0_5x = "72px";
    static const tableColumnWidthSize1_5x = "180px";
    static const tableColumnWidthSize2_5x = "240px";
    static const tableColumnWidthSize0_75x = "100px";
    ...
    static const teaserTitleStackSpace = "6px";
    ...
    static const aTeaserKickerFontSize = "24px";
    /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    static const aTeaserHeadlineFontSize = "64px";
    static const aTeaserKickerLineHeight = "24px";
    static const aTeaserHeadlineLineHeight = "64px";
    ...
    static const quadHeadlineFontSize = "100px";
    static const quadKickerFontSize = "24px";
    static const quadHeadlineLineHeight = "100px";
    ...
    static const dSysDocsWidthSize = "1440px";
    ...
    static const mainContentStageSize = "1024px";
    ...
    static const foundationsBannerHeightSize = "140px";
    ...
    static const dsCaptionStackSpace0_5x = "8px";
    static const dsCaptionStackSpace1x = "16px";
    /** This variable is used only for this design system's component tests. */
    static const 1columnMobile = "656px";
    ...
    static const thinBannerVerticalHeightSize = "186px";
...
Apply this token to the main frame of page layouts to simulate realistic vertical space. */
    static const canvasHeightSizeWeb = "768px";
    /** Common viewport width size based on the selected breakpoint.
Apply this token to the main frame of page layouts. */
    static const canvasWidthSizeWeb = "1024px";
    /** Common viewport width size based on the selected breakpoint.
Apply this token to the main frame of page layouts. */
    static const canvasWidthSizeApp = "1194px";
    /** Common viewport height size based on the selected mode.
Apply this token to the main frame of page layouts to simulate realistic vertical space. */
    static const canvasHeightSizeApp = "834px";
...
Apply this token to the main frame of page layouts to simulate realistic minimum widths across responsive viewports. */
    static const breakpointMinWidthSize = "1024px";
...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    static const breakpointMaxWidthSize = "1024px";
    ...
    static const layoutGuideGridColums = "12px";
    ...
    static const gridSpaceRespBase = "16px";
    /** 6-6-6-8 – use for side paddings and gutters in responsive layouts */
    static const gridSpaceRespSM = "8px";
    ...
    static const pageInlineSpace = "16px";
    ...
    static const kicker1FontSize = "30px";
    ...
    static const kicker2FontSize = "24px";
    ...
    static const label1FontSizeResponsive = "17px";
    ...
    static const title2FontSize = "20px";
    ...
    static const letterSpacingPositiveLG = "3px";
    ...
    /** -2 | -2 | -2 | -3 | This variable takes primitive letter spacing variables and creates this semantic variable for use on designs that change across device sizes. */
    static const letterSpacingNegativeLG = "-3px";
    ...
    static const display1LetterSpacing = "-2px";
    ...
    static const bodyLineHeight = "32px";

    // Semantic - Typography - LineHeight - Callout
    static const calloutLineHeight = "22px";

    // Semantic - Typography - LineHeight - Display
    static const display1LineHeight = "120px";
    static const display2LineHeight = "64px";
    static const display3LineHeight = "40px";

    // Semantic - Typography - LineHeight - Footnote
    static const footnote1LineHeight = "23px";
    static const footnote2LineHeight = "21px";

    // Semantic - Typography - LineHeight - Headline
    static const headline1LineHeight = "100px";
    static const headline2LineHeight = "64px";
    static const headline3LineHeight = "40px";
    static const headline4LineHeight = "30px";

    // Semantic - Typography - LineHeight - Kicker
    static const kicker4LineHeight = "16px";
    static const kicker3LineHeight = "20px";
    static const kicker2LineHeight = "24px";
    static const kicker1LineHeight = "30px";
    ...
    static const label1ResponsiveLineHeight = "17px";
    ...
    static const visilbleDesktopOnly = true;
    ...
    static const hideOnDesktop = false;

    // Semantic - Visibility - VariantSwitch
    static const changeOnLG = "lg";
