...
class BreakpointXs320px {
    ...
    static const componentArticleArticleHeadlineFontSize = 640.00; /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    static const componentTeaserATeaserATeaserHeadlineFontSize = 448.00; /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    static const componentTeaserATeaserATeaserHeadlineLineHeight = 448.00;
    ...
    static const componentTeaserMQTeaserMQTeaserHeadlineFontSize = 352.00; /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    static const componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 600;
    static const componentTeaserMQTeaserMQTeaserHeadlineLineHeight = 352.00;
    ...
    static const componentTeaserQTeaserQuadHeadlineFontSize = 768.00; /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    static const componentTeaserQTeaserQuadHeadlineLineHeight = 768.00;
...
semanticLayoutCanvasWidthSizeWeb = 5120.00;
    ...
    static const semanticTypographyFontSizeDisplayDisplay1FontSize = 640.00; /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    static const semanticTypographyFontSizeDisplayDisplay2FontSize = 576.00; /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    static const semanticTypographyFontSizeDisplayDisplay3FontSize = 448.00; /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    static const semanticTypographyFontSizeHeadlineHeadline1FontSize = 768.00; /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    static const semanticTypographyFontSizeHeadlineHeadline2FontSize = 640.00; /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    static const semanticTypographyFontSizeHeadlineHeadline3FontSize = 448.00; /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    ...
    static const semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 384.00; /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    static const semanticTypographyLineHeightCalloutCalloutLineHeight = 288.00;
    ...
    static const semanticTypographyLineHeightFootnoteFootnote2LineHeight = 249.60;
    static const semanticTypographyLineHeightHeadlineHeadline1LineHeight = 768.00;
    static const semanticTypographyLineHeightHeadlineHeadline2LineHeight = 640.00;
    static const semanticTypographyLineHeightHeadlineHeadline3LineHeight = 448.00;
    ...
    static const semanticTypographyLineHeightQuoteQuoteLineHeight = 256.00; /** This variable is used in the quote text style line height parameter. */
    static const semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = 384.00;
    static const semanticTypographyLineHeightTitleTitle1LineHeight = 352.00;
    static const semanticTypographyLineHeightTitleTitle2LineHeight = 281.60; /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
