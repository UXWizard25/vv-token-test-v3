...
class {
    ...
    static const componentAvatarAvatarLabelColor = Color(0xFF242629); /** 09-2025 css --article-author-name-color */
    ...
    static const componentChipsChipsBgColorActive = Color(0xFFDE0000);
    ...
    static const componentDropdownDropdownBgColorHover = Color(0xFFF2F5F5);
    static const componentDropdownDropdownBgColorIdle = Color(0xFFFFFFFF);
    static const componentEmptiesEmptiesBgColor = Color(0xFFF2F5F5);
    static const componentEmptiesEmptiesLogoColor = Color(0xFFCFD4D9);
    static const componentFoldoutFoldoutLabelColorActive = Color(0xFFDE0000);
    ...
    static const componentHeyHeyDrawerSurfaceColor = Color(0xFFF2F5F5);
    ...
    static const componentKickerStandardKickerBgColorOnSurface = Color(0xFFDE0000);
    ...
    static const componentMenuAppTopBarTextColorPrimary = Color(0xFF242629);
    static const componentMenuItemMenuItemBorderColorActive = Color(0xFFDE0000);
    ...
    static const componentPaginationPaginationElementColorActive = Color(0xFFDE0000);
    ...
    static const semanticAttentionAccentColorPrimary = Color(0xFFDE0000); /** Primary accent color used to emphasize interactive or highlight elements such as links, selection states, or focus indicators. Adapts in Darkmode to a fully white tone. */
...
semanticBorderBorderColorWarning = Color(0xFFDE0000);
    ...
    static const semanticCoreCoreColorTertiary = Color(0xFF242629); /** Represents tertiary brand accents. This variable changes across Light and Dark Mode. */
 ...
 */
semanticHeadingHeadlineColorPrimary = Color(0xFF242629);
    static const /**
 ...
 */
semanticHeadingKickerTextColorOnSurface = Color(0xFFDE0000);
    static const /**
 ...
 */
semanticSurfaceSurfaceColorPrimaryInverse = Color(0xFF242629);
 ...
 */
semanticSurfaceSurfaceColorSecondary = Color(0xFFF2F5F5);
    static const /**
 ...
 */
semanticSurfaceSurfaceColorTertiary = Color(0xFFE8EDF0);
    static const /**
 ...
 */
semanticSurfaceSurfaceColorTertiaryInverse = Color(0xFF333D40);
    static const semanticTextTextColorAccent = Color(0xFFDE0000); /** Accent text color used for links, interactive text, or highlighted key words. Changes from a red in light mode to a white in dark mode. */
    static const /**
