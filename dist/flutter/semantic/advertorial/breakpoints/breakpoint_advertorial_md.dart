...
class {
    ...
    static const componentArticleArticleHeadlineFontSize = 54; /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    static const componentTeaserATeaserATeaserHeadlineFontSize = 36; /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    static const componentTeaserATeaserATeaserHeadlineLineHeight = 39.6;
    static const componentTeaserATeaserATeaserKickerFontSize = 18; /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    ...
    static const componentTeaserMQTeaserMQTeaserHeadlineFontSize = 26; /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    ...
    static const componentTeaserQTeaserQuadHeadlineFontSize = 54; /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
...
semanticLayoutCanvasWidthSizeWeb = 600;
    ...
    static const semanticTypographyFontSizeDisplayDisplay1FontSize = 70; /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    static const semanticTypographyFontSizeDisplayDisplay2FontSize = 41; /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    static const semanticTypographyFontSizeDisplayDisplay3FontSize = 31; /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    static const semanticTypographyFontSizeHeadlineHeadline1FontSize = 54; /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    static const semanticTypographyFontSizeHeadlineHeadline2FontSize = 36; /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    static const semanticTypographyFontSizeHeadlineHeadline3FontSize = 26; /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    static const semanticTypographyFontSizeHeadlineHeadline4FontSize = 20; /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    ...
    static const semanticTypographyFontSizeKickerKicker3FontSize = 14; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 16 - 16 - 18 - 20 */
    ...
    static const semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 18; /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    static const semanticTypographyLineHeightQuoteQuoteLineHeight = 20.8; /** This variable is used in the quote text style line height parameter. */
    ...
    static const semanticTypographyLineHeightTitleTitle2LineHeight = 19.2; /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
