...
//
// breakpoint_advertorial_sm.dart
//
...
class {
    ...
    static const componentArticleArticleHeadlineFontSize = 30; /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    static const componentArticleArticleKickerFontSize = 16; /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    static const componentDSysDocsDSysDocsWidthSize = 750;
    ...
    static const componentDSysDocsMainContentStageSize = 750; /** This variable is used as a max width size for content blocks. For mobile devices this var references the DSysDocsWidthSize var 320 - 750 - 962 - 1024 */
    ...
    static const componentTabsAppsTabsLabelFontSize = 12; /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    ...
    static const componentTeaserATeaserATeaserHeadlineFontSize = 24; /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    static const componentTeaserATeaserATeaserHeadlineLineHeight = 24;
    static const componentTeaserATeaserATeaserKickerFontSize = 14; /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    static const componentTeaserATeaserATeaserKickerLineHeight = 14;
    ...
    static const componentTeaserMQTeaserMQTeaserHeadlineFontSize = 16; /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    static const componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 600;
    static const componentTeaserMQTeaserMQTeaserHeadlineLineHeight = 18.4;
    ...
    static const componentTeaserQTeaserQuadHeadlineFontSize = 36; /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    static const componentTeaserQTeaserQuadHeadlineLineHeight = 37.8;
    static const componentTeaserQTeaserQuadKickerFontSize = 16;
 ...
 */
semanticLayoutBreakpointsBreakpointMaxWidthSize = 599;
    static const /**
 ...
 */
semanticLayoutBreakpointsBreakpointMinWidthSize = 390;
    static const /**
 ...
 */
semanticLayoutCanvasHeightSizeApp = 844;
    static const /**
 * Common viewport height size based on the selected mode.
 * Apply this token to the main frame of page layouts to simulate realistic vertical space.
 */
semanticLayoutCanvasHeightSizeWeb = 844;
    static const /**
 * Common viewport width size based on the selected breakpoint.
 * Apply this token to the main frame of page layouts.
 */
semanticLayoutCanvasWidthSizeApp = 390;
    static const /**
 * Common viewport width size based on the selected breakpoint.
 * Apply this token to the main frame of page layouts.
 */
semanticLayoutCanvasWidthSizeWeb = 390;
    ...
    static const semanticTypographyFontSizeCalloutCallout1FontSize = 16; /** This token is used for the font size parameter of the callout text style. 18 - 18 - 22 - 22 */
    static const semanticTypographyFontSizeDisplayDisplay1FontSize = 39; /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    static const semanticTypographyFontSizeDisplayDisplay2FontSize = 35; /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    static const semanticTypographyFontSizeDisplayDisplay3FontSize = 27; /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    static const semanticTypographyFontSizeHeadlineHeadline1FontSize = 36; /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    static const semanticTypographyFontSizeHeadlineHeadline2FontSize = 30; /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    static const semanticTypographyFontSizeHeadlineHeadline3FontSize = 24; /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    static const semanticTypographyFontSizeHeadlineHeadline4FontSize = 16; /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    static const semanticTypographyFontSizeKickerKicker1FontSize = 16; /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    static const semanticTypographyFontSizeKickerKicker2FontSize = 16; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24 */
    ...
    static const semanticTypographyFontSizeKickerKicker4FontSize = 12; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 14 - 14 - 16 - 16 */
    ...
    static const semanticTypographyFontSizeTitleTitle2FontSize = 14; /** 16 - 16 - 18 - 20 - html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
    ...
    static const semanticTypographyLineHeightCalloutCalloutLineHeight = 20.8;
    ...
    static const semanticTypographyLineHeightHeadlineHeadline1LineHeight = 37.8;
    static const semanticTypographyLineHeightHeadlineHeadline2LineHeight = 33;
    static const semanticTypographyLineHeightHeadlineHeadline3LineHeight = 26.4;
    static const semanticTypographyLineHeightHeadlineHeadline4LineHeight = 18.4;
    static const semanticTypographyLineHeightKickerKicker1LineHeight = 17.6;
    ...
    static const semanticTypographyLineHeightKickerKicker4LineHeight = 13.2;
    ...
    static const semanticTypographyLineHeightTitleTitle2LineHeight = 16.8; /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
