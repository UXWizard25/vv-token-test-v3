...
class {
    ...
    static const componentArticleArticleHeadlineFontSize = 42; /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    static const componentArticleArticleKickerFontSize = 20; /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    static const componentTeaserATeaserATeaserHeadlineFontSize = 30; /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    ...
    static const componentTeaserMQTeaserMQTeaserHeadlineFontSize = 21; /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    ...
    static const componentTeaserQTeaserQuadHeadlineFontSize = 42; /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
...
semanticLayoutCanvasWidthSizeWeb = 390;
    ...
    static const semanticTypographyFontSizeDisplayDisplay1FontSize = 38; /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    static const semanticTypographyFontSizeDisplayDisplay2FontSize = 34; /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    ...
    static const semanticTypographyFontSizeHeadlineHeadline1FontSize = 42; /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    static const semanticTypographyFontSizeHeadlineHeadline2FontSize = 42; /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    ...
    static const semanticTypographyFontSizeHeadlineHeadline4FontSize = 21; /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    static const semanticTypographyFontSizeKickerKicker1FontSize = 20; /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    ...
    static const semanticTypographyFontSizeTitleTitle1FontSize = 24; /** 22 - 22 - 22 - 28 -- html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
    ...
    static const semanticTypographyLineHeightTitleTitle2LineHeight = 20.8; /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
