...
class {
    ...
    static const componentArticleArticleHeadlineFontSize = 80; /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    static const componentArticleArticleImageCaptionFontSize = 15; /** CSS --article-figure-meta-font-size 16-16-18-18 */
    ...
    static const componentArticleArticleImageSourceFontSize = 15; /** NMT CSS --article-figure-meta-font-size */
    ...
    static const componentArticleArticleKickerFontSize = 32; /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    static const componentBreadcrumbBreadcrumbFontSize = 11; /** 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices. */
    static const componentBreadcrumbBreadcrumbFontWeight = 400;
    static const componentBreadcrumbBreadcrumbInlineSpace = 0;
    static const componentBreadcrumbBreadcrumbLineHeight = 11; /** 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices. */
    ...
    static const componentMenuAppTopbarTitleFontSize = 13;
    ...
    static const componentMenuMenuItemFontSize = 18; /** This variable is used on the menu link lane and on the mobile side menu drawer. */
    ...
    static const componentTeaserATeaserATeaserHeadlineFontSize = 50; /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    static const componentTeaserATeaserATeaserHeadlineLineHeight = 57.6;
    static const componentTeaserATeaserATeaserKickerFontSize = 26; /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    static const componentTeaserATeaserATeaserKickerLineHeight = 26;
    static const componentTeaserATeaserATeaserTitleInlineSpace = 16;
    ...
    static const componentTeaserMQTeaserMQTeaserHeadlineFontSize = 34; /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    static const componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700;
    static const componentTeaserMQTeaserMQTeaserHeadlineLineHeight = 39.1;
    static const componentTeaserMQTeaserMqTeaserTitleInlineSpace = 12;
    static const componentTeaserQTeaserQTeaserTitleInlineSpace = 24;
    static const componentTeaserQTeaserQuadHeadlineFontSize = 80; /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    static const componentTeaserQTeaserQuadHeadlineLineHeight = 88;
    static const componentTeaserQTeaserQuadKickerFontSize = 26;
    ...
    static const componentTeaserSuperASuperATeaserTitleInlineSpace = 24; /** 16 - 16 - 16 - 16 */
...
semanticLayoutCanvasWidthSizeWeb = 1024;
    ...
    static const semanticTypographyFontSizeCalloutCallout1FontSize = 24; /** This token is used for the font size parameter of the callout text style. 18 - 18 - 22 - 22 */
    static const semanticTypographyFontSizeDisplayDisplay1FontSize = 114; /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    static const semanticTypographyFontSizeDisplayDisplay2FontSize = 61; /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    static const semanticTypographyFontSizeDisplayDisplay3FontSize = 38; /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    static const semanticTypographyFontSizeHeadlineHeadline1FontSize = 80; /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    static const semanticTypographyFontSizeHeadlineHeadline2FontSize = 50; /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    static const semanticTypographyFontSizeHeadlineHeadline3FontSize = 34; /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    static const semanticTypographyFontSizeHeadlineHeadline4FontSize = 26; /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    static const semanticTypographyFontSizeKickerKicker1FontSize = 32; /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    static const semanticTypographyFontSizeKickerKicker2FontSize = 26; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24 */
    static const semanticTypographyFontSizeKickerKicker3FontSize = 22; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 16 - 16 - 18 - 20 */
    static const semanticTypographyFontSizeKickerKicker4FontSize = 18; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 14 - 14 - 16 - 16 */
    ...
    static const semanticTypographyFontSizeQuoteQuoteFontSize = 20; /** 16 - 16 - 18 - 20 -- This variable is used for controlling the font size of the quote text style. */
    static const semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 26; /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    static const semanticTypographyFontSizeTitleTitle1FontSize = 30; /** 22 - 22 - 22 - 28 -- html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
    static const semanticTypographyFontSizeTitleTitle2FontSize = 20; /** 16 - 16 - 18 - 20 - html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
    ...
    static const semanticTypographyLineHeightBodyBodyLineHeight = 28.05; /** Figma's font line height currently does not allow for multipliers as is used on current website css var(--body-line-height) */
    static const semanticTypographyLineHeightCalloutCalloutLineHeight = 31.2;
    ...
    static const semanticTypographyLineHeightFootnoteFootnote1LineHeight = 19;
    static const semanticTypographyLineHeightFootnoteFootnote2LineHeight = 17.03;
    static const semanticTypographyLineHeightHeadlineHeadline1LineHeight = 88;
    static const semanticTypographyLineHeightHeadlineHeadline2LineHeight = 57.6;
    static const semanticTypographyLineHeightHeadlineHeadline3LineHeight = 39.1;
    static const semanticTypographyLineHeightHeadlineHeadline4LineHeight = 29.9;
    static const semanticTypographyLineHeightKickerKicker1LineHeight = 35.2;
    static const semanticTypographyLineHeightKickerKicker2LineHeight = 28.6;
    static const semanticTypographyLineHeightKickerKicker3LineHeight = 24.2;
    static const semanticTypographyLineHeightKickerKicker4LineHeight = 19.8;
    ...
    static const semanticTypographyLineHeightLabelLabel1ResponsiveLineHeight = 20.4;
    ...
    static const semanticTypographyLineHeightQuoteQuoteLineHeight = 26; /** This variable is used in the quote text style line height parameter. */
    static const semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = 33.8;
    static const semanticTypographyLineHeightTitleTitle1LineHeight = 33;
    static const semanticTypographyLineHeightTitleTitle2LineHeight = 26; /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
