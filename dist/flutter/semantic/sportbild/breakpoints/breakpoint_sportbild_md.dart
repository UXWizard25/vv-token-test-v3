...
class {
    ...
    static const componentArticleArticleContentInlineSpace = 72; /** 16 | 16 | 72 | 162 - This variable is used for making the left and right spacings around article content blocks. Current css has the article-body class assigned to a div and article body contains these horizontal padding values. */
    static const componentArticleArticleContentStackSpace = 24; /** 16 - 16 - 24 - 32 - This variable creates the vertical spacing between different article body elements such as avatars, media players, corssheadings, paragraphs, field sets, images, tables, quotes, videos, social embeds, etc. */
    static const componentArticleArticleGalleryATeaserWidth = 260; /** same as standard teaser width size variable */
    static const componentArticleArticleHeadingsInlineSpace = 72; /** 16 | 16 | 72 | 16 - This variable is used for the left and right space within the article page headings container which holds the article page kicker, headline and subheadline. */
    ...
    static const componentArticleArticleHeadlineFontSize = 60; /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    static const componentArticleArticleImageCaptionFontSize = 13; /** CSS --article-figure-meta-font-size 16-16-18-18 */
    static const componentArticleArticleImageCaptionLineHeight = 16.9; /** this component level variable references the branding variables */
    ...
    static const componentArticleArticleImageSourceFontSize = 13; /** NMT CSS --article-figure-meta-font-size */
    ...
    static const componentArticleArticleKickerFontSize = 26; /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    static const componentArticleArticleMetaFontSize = 14; /** This variable is used on the font size of article day&time stamp that usually shows up along with the article author avatars. On app versions this variable is used for the avatar names. 12 - 12 - 14 - 16 */
    static const componentArticleArticleTopMarginSpace = 12; /** 8 | 8 | 12 | 16 - This space variable is used at the top edge of the article main content bounding box. */
    ...
    static const componentAvatarAvatarLabelFontSize = 13; /** This variable is used on avatar names in article pages. Bild: 16 - 16 - 16 - 18; SpoBi&Ads: 13 - 13 - 13 - 15 */
    ...
    static const componentBreadcrumbBreadcrumbFontSize = 14; /** 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices. */
    static const componentBreadcrumbBreadcrumbFontWeight = 400;
    static const componentBreadcrumbBreadcrumbInlineSpace = 12;
    static const componentBreadcrumbBreadcrumbLineHeight = 14; /** 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices. */
    ...
    static const componentDSysDocs1columnMobile = 930; /** This variable is used only for this design system's component tests. */
    ...
    static const componentDSysDocsDSysDocsWidthSize = 962;
    static const componentDSysDocsDocHeaderHeightSize = 160; /** This variable is used on documentation headers that contain info about platfroms and component names. 144 - 144 - 160 - 180 */
    static const componentDSysDocsDsCaptionStackSpace05x = 6; /** This variable is used in documentation pages that have small caption or lables along with a UI component documented. 4 - 4 - 6 - 8 */
    static const componentDSysDocsDsCaptionStackSpace1x = 12;
    ...
    static const componentDSysDocsMainContentStageSize = 962; /** This variable is used as a max width size for content blocks. For mobile devices this var references the DSysDocsWidthSize var 320 - 750 - 962 - 1024 */
    ...
    static const componentTableTableColumnWidthSize05x = 48;
    static const componentTableTableColumnWidthSize075x = 64;
    static const componentTableTableColumnWidthSize15x = 160;
    ...
    static const componentTeaserATeaserATeaserHeadlineFontSize = 44; /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    static const componentTeaserATeaserATeaserHeadlineLineHeight = 50.6;
    ...
    static const componentTeaserMQTeaserMQTeaserHeadlineFontSize = 30; /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    static const componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700;
    static const componentTeaserMQTeaserMQTeaserHeadlineLineHeight = 34.5;
    ...
    static const componentTeaserQTeaserQuadHeadlineFontSize = 60; /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    static const componentTeaserQTeaserQuadHeadlineLineHeight = 69;
    ...
    static const componentToggleSwitchAppToggleItemLabelFontSize = 16; /** This variable is used on labels in list items with toggle switches found in app preferences. 14 - 14 - 16 - 18 */
    static const componentToggleSwitchAppToggleItemLabelLineHeight = 16.2; /** This variable is used on labels in list items with toggle switches found in app preferences. 14.1 - 14.1 - 16.2 - 18.2 */
    ...
    static const componentVideoVideoRedPlayIconHeightSize = 14; /** This variable is used for changing the red play icon inside the white square. */
    ...
    static const componentVideoVideoTimeBadgeSize = 32; /** 24 - 24 - 32 - 40 - This variable is used on horizontal video badges that contain a red play icon on top of a white square next to a timestamp. */
 ...
 */
semanticLayoutBreakpointsBreakpointMaxWidthSize = 1023;
    static const /**
 ...
 */
semanticLayoutBreakpointsBreakpointMinWidthSize = 600;
    static const /**
 ...
 */
semanticLayoutCanvasHeightSizeApp = 1194;
    static const /**
 * Common viewport height size based on the selected mode.
 * Apply this token to the main frame of page layouts to simulate realistic vertical space.
 */
semanticLayoutCanvasHeightSizeWeb = 960;
    static const /**
 * Common viewport width size based on the selected breakpoint.
 * Apply this token to the main frame of page layouts.
 */
semanticLayoutCanvasWidthSizeApp = 834;
    static const /**
 * Common viewport width size based on the selected breakpoint.
 * Apply this token to the main frame of page layouts.
 */
semanticLayoutCanvasWidthSizeWeb = 600;
    ...
    static const semanticLayoutGridLayoutGuideLayoutGuideGridColums = 8; /** Used to set the column count in Figma Layout guide Grids */
    ...
    static const semanticSizeResponsiveSizeResp2Xl = 92; /** 72-72-92-100 – Use for setting height and width of UI elements that scale across breakpoints */
    ...
    static const semanticSizeResponsiveSizeResp3Xl = 120; /** 96-96-120-148 – Use for setting height and width of UI elements that scale across breakpoints */
    ...
    static const semanticSizeResponsiveSizeResp4Xl = 160; /** 148-148-160-180 – Use for setting height and width of UI elements that scale across breakpoints */
    static const semanticSizeResponsiveSizeResp4Xs = 14; /** 12-12-14-16 – Use for setting height and width of UI elements that scale across breakpoints */
    static const semanticSizeResponsiveSizeRespLg = 72; /** 56-56-72-92 – Use for setting height and width of UI elements that scale across breakpoints */
    static const semanticSizeResponsiveSizeRespMd = 64; /** 48-48-64-72 – Use for setting height and width of UI elements that scale across breakpoints */
    static const semanticSizeResponsiveSizeRespSm = 48; /** 40-40-48-56 – Use for setting height and width of UI elements that scale across breakpoints */
    static const semanticSizeResponsiveSizeRespXl = 80; /** 64-64-80-96 – Use for setting height and width of UI elements that scale across breakpoints */
    static const semanticSizeResponsiveSizeRespXs = 40; /** 32-32-40-48 – Use for setting height and width of UI elements that scale across breakpoints */
    ...
    static const semanticSpaceGapResponsiveGapSpaceResp2Xl = 48; /** 32-32-48-64 – Use for gaps between items inside of UI elements that scale across breakpoints */
    static const semanticSpaceGapResponsiveGapSpaceResp2Xs = 4; /** 2-2-4-6 – Use for gaps between items inside of UI elements that scale across breakpoints */
    static const semanticSpaceGapResponsiveGapSpaceResp3Xl = 72; /** 48-48-72-96 – Use for gaps between items inside of UI elements that scale across breakpoints */
    static const semanticSpaceGapResponsiveGapSpaceRespLg = 24; /** 16-16-24-32 – Use for gaps between items inside of UI elements that scale across breakpoints */
    static const semanticSpaceGapResponsiveGapSpaceRespMd = 16; /** 12-12-16-24 – Use for gaps between items inside of UI elements that scale across breakpoints */
    static const semanticSpaceGapResponsiveGapSpaceRespSm = 12; /** 8-8-12-16 – Use for gaps between items inside of UI elements that scale across breakpoints */
    static const semanticSpaceGapResponsiveGapSpaceRespXl = 32; /** 24-24-32-48 – Use for gaps between items inside of UI elements that scale across breakpoints */
    static const semanticSpaceGapResponsiveGapSpaceRespXs = 6; /** 4-4-6-8 – Use for gaps between items inside of UI elements that scale across breakpoints */
    ...
    static const semanticSpaceInlineResponsiveInlineSpaceResp2Xl = 48; /** 32-32-48-64 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    static const semanticSpaceInlineResponsiveInlineSpaceRespLg = 24; /** 16-16-24-32 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    static const semanticSpaceInlineResponsiveInlineSpaceRespMd = 16; /** 12-12-16-24 use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    static const semanticSpaceInlineResponsiveInlineSpaceRespSm = 12; /** 8-8-12-16 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    static const semanticSpaceInlineResponsiveInlineSpaceRespXl = 32; /** 24-24-32-40 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    ...
    static const semanticSpaceStackResponsiveStackSpaceResp2Xl = 48; /** 32-32-48-64 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    static const semanticSpaceStackResponsiveStackSpaceRespLg = 24; /** 16-16-24-32 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    static const semanticSpaceStackResponsiveStackSpaceRespMd = 16; /** 12-12-16-24 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    static const semanticSpaceStackResponsiveStackSpaceRespSm = 12; /** 8-8-12-16 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    static const semanticSpaceStackResponsiveStackSpaceRespXl = 32; /** 24-24-32-40 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    ...
    static const semanticTypographyFontSizeDisplayDisplay1FontSize = 68; /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    static const semanticTypographyFontSizeDisplayDisplay2FontSize = 40; /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    static const semanticTypographyFontSizeDisplayDisplay3FontSize = 30; /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    static const semanticTypographyFontSizeFootnoteFootnote1FontSize = 13; /** This token is used on the footnote text style font size parameter. 16 - 16 - 16 - 18 */
    static const semanticTypographyFontSizeFootnoteFootnote2FontSize = 10; /** This token is used in the font size parameter of the footnote2 text style. 12 - 12 - 12 - 16 */
    static const semanticTypographyFontSizeHeadlineHeadline1FontSize = 60; /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    static const semanticTypographyFontSizeHeadlineHeadline2FontSize = 44; /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    static const semanticTypographyFontSizeHeadlineHeadline3FontSize = 30; /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    ...
    static const semanticTypographyFontSizeKickerKicker1FontSize = 26; /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    ...
    static const semanticTypographyFontSizeLabelLabel1FontSizeResponsive = 15; /** 10 - 10 - 15 - 17 Use this label font size when you want your label's font size to change across device sizes. */
    ...
    static const semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 22; /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    static const semanticTypographyLetterSpacingDisplayDisplay1LetterSpacing = -1; /** -0.5 | -0.5 | -1 | -2 | This variable is used for the letter spacing parameter of the display1 text style. On smaller devices the value is smaller than on larger devices. On desktop devices the letter spacing is further reduced for making the text style more compact. */
    ...
    static const semanticTypographyLineHeightHeadlineHeadline1LineHeight = 69;
    static const semanticTypographyLineHeightHeadlineHeadline2LineHeight = 50.6;
    static const semanticTypographyLineHeightHeadlineHeadline3LineHeight = 34.5;
    static const semanticTypographyLineHeightHeadlineHeadline4LineHeight = 28.6;
    static const semanticTypographyLineHeightKickerKicker1LineHeight = 28.6;
    static const semanticTypographyLineHeightKickerKicker2LineHeight = 28.6;
    static const semanticTypographyLineHeightKickerKicker3LineHeight = 22;
    static const semanticTypographyLineHeightKickerKicker4LineHeight = 17.6;
    ...
    static const semanticTypographyLineHeightLabelLabel1ResponsiveLineHeight = 18;
    ...
    static const semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = 28.6;
    static const semanticTypographyLineHeightTitleTitle1LineHeight = 30.8;
