...
class {
    ...
    static const componentAvatarAvatarLabelColor = Color(0xFFE8EDF0); /** 09-2025 css --article-author-name-color */
    ...
    static const componentButtonButtonLiveTickerLoadNewSurfaceColor = Color(0xFF081729);
    static const componentButtonGhostButtonGhostBgColorHover = Color(0x80CFD4D9);
    static const componentButtonPrimaryButtonPrimaryBrandBgColorHover = Color(0xFF174582);
    static const componentButtonPrimaryButtonPrimaryBrandBgColorIdle = Color(0xFF305999);
    static const componentButtonPrimaryButtonPrimaryLabelColor = Color(0xFFFFFFFF);
    static const componentButtonPrimaryButtonPrimaryNeutralBgColorHover = Color(0xFFBDC9DB);
    ...
    static const componentCardCardSurfaceBgColor = Color(0xFF0A264F);
    ...
    static const componentChipsChipsLabelColorHover = Color(0xFF081729);
    ...
    static const componentDropdownDropdownBgColorIdle = Color(0xFF174582);
    static const componentEmptiesEmptiesBgColor = Color(0xFF174582);
    ...
    static const componentHeyHeyDrawerSurfaceColor = Color(0xFF174582);
    ...
    static const componentMenuItemMenuItemBorderColorActive = Color(0xFFF7FAFC);
    ...
    static const componentMenuMenuLinkLaneLabelColor = Color(0xFFADB5BA);
    static const componentMenuMenuLinkLaneLabelColorActive = Color(0xFFF7FAFC);
    ...
    static const componentMenuMenuSurfaceColor = Color(0xFF081729);
    ...
    static const componentPaginationPaginationElementColorActive = Color(0xFFF7FAFC);
    ...
    static const componentTabAppBottomTabBarBgColor = Color(0xFF0A264F);
    ...
    static const semanticAttentionAccentColorPrimary = Color(0xFFF7FAFC); /** Primary accent color used to emphasize interactive or highlight elements such as links, selection states, or focus indicators. Adapts in Darkmode to a fully white tone. */
...
semanticBorderBorderColorWarning = Color(0xFFDE0000);
    ...
    static const semanticCoreCoreColorSecondary = Color(0xFF081729); /** Defines the secondary brand tone. This variable changes across Light and Dark Mode. */
 ...
 */
semanticSurfaceSurfaceColorPrimary = Color(0xFF081729);
    static const /**
 ...
 */
semanticSurfaceSurfaceColorSecondary = Color(0xFF0A264F);
    static const /**
 ...
 */
semanticSurfaceSurfaceColorTertiary = Color(0xFF174582);
    static const /**
 ...
 */
semanticSurfaceSurfaceColorTertiaryInverse = Color(0xFFBDC9DB);
    static const semanticTextTextColorAccent = Color(0xFFF7FAFC); /** Accent text color used for links, interactive text, or highlighted key words. Changes from a red in light mode to a white in dark mode. */
    static const /**
