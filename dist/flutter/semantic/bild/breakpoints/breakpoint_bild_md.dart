...
class {
    ...
    static const componentArticleArticleHeadlineFontSize = 72; /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    static const componentArticleArticleKickerFontSize = 22; /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    static const componentTeaserATeaserATeaserHeadlineLineHeight = 48;
    static const componentTeaserATeaserATeaserKickerFontSize = 22; /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    static const componentTeaserATeaserATeaserKickerLineHeight = 22;
    ...
    static const componentTeaserMQTeaserMQTeaserHeadlineFontSize = 36; /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    static const componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700;
    static const componentTeaserMQTeaserMQTeaserHeadlineLineHeight = 36;
    ...
    static const componentTeaserQTeaserQuadHeadlineFontSize = 72; /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    static const componentTeaserQTeaserQuadHeadlineLineHeight = 72;
    static const componentTeaserQTeaserQuadKickerFontSize = 22;
...
semanticLayoutCanvasWidthSizeWeb = 600;
    ...
    static const semanticTypographyFontSizeDisplayDisplay1FontSize = 72; /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    static const semanticTypographyFontSizeDisplayDisplay2FontSize = 42; /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    static const semanticTypographyFontSizeDisplayDisplay3FontSize = 32; /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    static const semanticTypographyFontSizeHeadlineHeadline1FontSize = 72; /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    ...
    static const semanticTypographyFontSizeHeadlineHeadline3FontSize = 36; /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    ...
    static const semanticTypographyFontSizeKickerKicker1FontSize = 22; /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    static const semanticTypographyFontSizeKickerKicker2FontSize = 22; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24 */
    static const semanticTypographyFontSizeKickerKicker3FontSize = 18; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 16 - 16 - 18 - 20 */
    ...
    static const semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 32; /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    static const semanticTypographyLineHeightFootnoteFootnote2LineHeight = 15.8;
    static const semanticTypographyLineHeightHeadlineHeadline1LineHeight = 72;
    static const semanticTypographyLineHeightHeadlineHeadline2LineHeight = 48;
    static const semanticTypographyLineHeightHeadlineHeadline3LineHeight = 36;
    ...
    static const semanticTypographyLineHeightKickerKicker2LineHeight = 22;
    static const semanticTypographyLineHeightKickerKicker3LineHeight = 18;
    ...
    static const semanticTypographyLineHeightQuoteQuoteLineHeight = 18; /** This variable is used in the quote text style line height parameter. */
    static const semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = 32;
    static const semanticTypographyLineHeightTitleTitle1LineHeight = 22;
    static const semanticTypographyLineHeightTitleTitle2LineHeight = 19.8; /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
