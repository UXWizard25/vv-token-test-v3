...
class {
    ...
    static const componentArticleArticleHeadlineFontSize = 100; /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    static const componentArticleArticleImageCaptionFontSize = 18; /** CSS --article-figure-meta-font-size 16-16-18-18 */
    static const componentArticleArticleImageCaptionLineHeight = 24.75; /** this component level variable references the branding variables */
    ...
    static const componentArticleArticleImageSourceFontSize = 18; /** NMT CSS --article-figure-meta-font-size */
    static const componentArticleArticleImageSourceLineHeight = 23;
    static const componentArticleArticleInfoboxInlineSpace = 32;
    static const componentArticleArticleInfoboxStackSpace = 32;
    static const componentArticleArticleKickerFontSize = 30; /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    static const componentAvatarAvatarLabelFontSize = 18; /** This variable is used on avatar names in article pages. Bild: 16 - 16 - 16 - 18; SpoBi&Ads: 13 - 13 - 13 - 15 */
    ...
    static const componentTeaserATeaserATeaserHeadlineFontSize = 64; /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    static const componentTeaserATeaserATeaserHeadlineLineHeight = 64;
    static const componentTeaserATeaserATeaserKickerFontSize = 24; /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    static const componentTeaserATeaserATeaserKickerLineHeight = 24;
    ...
    static const componentTeaserMQTeaserMQTeaserHeadlineFontSize = 40; /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    static const componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700;
    static const componentTeaserMQTeaserMQTeaserHeadlineLineHeight = 40;
    ...
    static const componentTeaserQTeaserQuadHeadlineFontSize = 100; /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    static const componentTeaserQTeaserQuadHeadlineLineHeight = 100;
    static const componentTeaserQTeaserQuadKickerFontSize = 24;
...
semanticLayoutCanvasWidthSizeWeb = 1024;
    ...
    static const semanticTypographyFontSizeDisplayDisplay1FontSize = 120; /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    static const semanticTypographyFontSizeDisplayDisplay2FontSize = 64; /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    static const semanticTypographyFontSizeDisplayDisplay3FontSize = 40; /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    static const semanticTypographyFontSizeFootnoteFootnote1FontSize = 18; /** This token is used on the footnote text style font size parameter. 16 - 16 - 16 - 18 */
    static const semanticTypographyFontSizeFootnoteFootnote2FontSize = 16; /** This token is used in the font size parameter of the footnote2 text style. 12 - 12 - 12 - 16 */
    static const semanticTypographyFontSizeHeadlineHeadline1FontSize = 100; /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    static const semanticTypographyFontSizeHeadlineHeadline2FontSize = 64; /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    static const semanticTypographyFontSizeHeadlineHeadline3FontSize = 40; /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    static const semanticTypographyFontSizeHeadlineHeadline4FontSize = 32; /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    static const semanticTypographyFontSizeKickerKicker1FontSize = 30; /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    static const semanticTypographyFontSizeKickerKicker2FontSize = 24; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24 */
    static const semanticTypographyFontSizeKickerKicker3FontSize = 20; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 16 - 16 - 18 - 20 */
    static const semanticTypographyFontSizeKickerKicker4FontSize = 16; /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 14 - 14 - 16 - 16 */
    ...
    static const semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 36; /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    static const semanticTypographyLineHeightBodyBodyLineHeight = 32; /** Figma's font line height currently does not allow for multipliers as is used on current website css var(--body-line-height) */
    static const semanticTypographyLineHeightCalloutCalloutLineHeight = 22;
    ...
    static const semanticTypographyLineHeightFootnoteFootnote1LineHeight = 23;
    static const semanticTypographyLineHeightFootnoteFootnote2LineHeight = 21;
    static const semanticTypographyLineHeightHeadlineHeadline1LineHeight = 100;
    static const semanticTypographyLineHeightHeadlineHeadline2LineHeight = 64;
    static const semanticTypographyLineHeightHeadlineHeadline3LineHeight = 40;
    static const semanticTypographyLineHeightHeadlineHeadline4LineHeight = 30;
    static const semanticTypographyLineHeightKickerKicker1LineHeight = 30;
    static const semanticTypographyLineHeightKickerKicker2LineHeight = 24;
    static const semanticTypographyLineHeightKickerKicker3LineHeight = 20;
    static const semanticTypographyLineHeightKickerKicker4LineHeight = 16;
    ...
    static const semanticTypographyLineHeightQuoteQuoteLineHeight = 22; /** This variable is used in the quote text style line height parameter. */
    static const semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = 36;
    static const semanticTypographyLineHeightTitleTitle1LineHeight = 28;
    static const semanticTypographyLineHeightTitleTitle2LineHeight = 22; /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
