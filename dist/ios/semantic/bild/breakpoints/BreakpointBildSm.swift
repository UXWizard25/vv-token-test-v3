...
public class {
    ...
    public static let componentArticleArticleHeadlineFontSize = 40 /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    public static let componentArticleArticleImageCaptionFontSize = 16 /** CSS --article-figure-meta-font-size 16-16-18-18 */
    ...
    public static let componentTeaserATeaserATeaserHeadlineFontSize = 28 /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    ...
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontSize = 22 /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    ...
    public static let componentTeaserQTeaserQuadHeadlineFontSize = 48 /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
...
semanticLayoutCanvasWidthSizeWeb = 390
    ...
    public static let semanticTypographyFontSizeDisplayDisplay1FontSize = 40 /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    public static let semanticTypographyFontSizeDisplayDisplay2FontSize = 36 /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let semanticTypographyFontSizeDisplayDisplay3FontSize = 28 /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    public static let semanticTypographyFontSizeHeadlineHeadline1FontSize = 48 /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    public static let semanticTypographyFontSizeHeadlineHeadline2FontSize = 40 /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    public static let semanticTypographyFontSizeHeadlineHeadline3FontSize = 28 /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    public static let semanticTypographyFontSizeHeadlineHeadline4FontSize = 22 /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    ...
    public static let semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 24 /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    public static let semanticTypographyLineHeightQuoteQuoteLineHeight = 16 /** This variable is used in the quote text style line height parameter. */
    ...
    public static let semanticTypographyLineHeightTitleTitle2LineHeight = 17.6 /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
