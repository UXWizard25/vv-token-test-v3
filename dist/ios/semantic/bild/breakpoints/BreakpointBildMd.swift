...
public class {
    ...
    public static let componentArticleArticleContentInlineSpace = 72 /** 16 | 16 | 72 | 162 - This variable is used for making the left and right spacings around article content blocks. Current css has the article-body class assigned to a div and article body contains these horizontal padding values. */
    public static let componentArticleArticleContentStackSpace = 24 /** 16 - 16 - 24 - 32 - This variable creates the vertical spacing between different article body elements such as avatars, media players, corssheadings, paragraphs, field sets, images, tables, quotes, videos, social embeds, etc. */
    public static let componentArticleArticleGalleryATeaserWidth = 260 /** same as standard teaser width size variable */
    public static let componentArticleArticleHeadingsInlineSpace = 72 /** 16 | 16 | 72 | 16 - This variable is used for the left and right space within the article page headings container which holds the article page kicker, headline and subheadline. */
    ...
    public static let componentArticleArticleHeadlineFontSize = 72 /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    public static let componentArticleArticleImageSourceFontSize = 16 /** NMT CSS --article-figure-meta-font-size */
    ...
    public static let componentArticleArticleKickerFontSize = 22 /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    public static let componentArticleArticleMetaFontSize = 14 /** This variable is used on the font size of article day&time stamp that usually shows up along with the article author avatars. On app versions this variable is used for the avatar names. 12 - 12 - 14 - 16 */
    public static let componentArticleArticleTopMarginSpace = 12 /** 8 | 8 | 12 | 16 - This space variable is used at the top edge of the article main content bounding box. */
    ...
    public static let componentAvatarAvatarLabelFontSize = 16 /** This variable is used on avatar names in article pages. Bild: 16 - 16 - 16 - 18; SpoBi&Ads: 13 - 13 - 13 - 15 */
    ...
    public static let componentDSysDocs1columnMobile = 930 /** This variable is used only for this design system's component tests. */
    ...
    public static let componentDSysDocsDSysDocsWidthSize = 962
    public static let componentDSysDocsDocHeaderHeightSize = 160 /** This variable is used on documentation headers that contain info about platfroms and component names. 144 - 144 - 160 - 180 */
    public static let componentDSysDocsDsCaptionStackSpace05x = 6 /** This variable is used in documentation pages that have small caption or lables along with a UI component documented. 4 - 4 - 6 - 8 */
    public static let componentDSysDocsDsCaptionStackSpace1x = 12
    ...
    public static let componentDSysDocsMainContentStageSize = 962 /** This variable is used as a max width size for content blocks. For mobile devices this var references the DSysDocsWidthSize var 320 - 750 - 962 - 1024 */
    ...
    public static let componentTableTableColumnWidthSize05x = 48
    public static let componentTableTableColumnWidthSize075x = 64
    public static let componentTableTableColumnWidthSize15x = 160
    ...
    public static let componentTeaserATeaserATeaserHeadlineFontSize = 48 /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    public static let componentTeaserATeaserATeaserHeadlineLineHeight = 48
    public static let componentTeaserATeaserATeaserKickerFontSize = 22 /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    public static let componentTeaserATeaserATeaserKickerLineHeight = 22
    ...
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontSize = 36 /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700
    public static let componentTeaserMQTeaserMQTeaserHeadlineLineHeight = 36
    public static let componentTeaserMQTeaserMqTeaserTitleInlineSpace = 8
    public static let componentTeaserQTeaserQTeaserTitleInlineSpace = 16
    public static let componentTeaserQTeaserQuadHeadlineFontSize = 72 /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    public static let componentTeaserQTeaserQuadHeadlineLineHeight = 72
    public static let componentTeaserQTeaserQuadKickerFontSize = 22
    ...
    public static let componentToggleSwitchAppToggleItemLabelFontSize = 16 /** This variable is used on labels in list items with toggle switches found in app preferences. 14 - 14 - 16 - 18 */
    public static let componentToggleSwitchAppToggleItemLabelLineHeight = 16.2 /** This variable is used on labels in list items with toggle switches found in app preferences. 14.1 - 14.1 - 16.2 - 18.2 */
    ...
    public static let componentVideoVideoRedPlayIconHeightSize = 14 /** This variable is used for changing the red play icon inside the white square. */
    ...
    public static let componentVideoVideoTimeBadgeSize = 32 /** 24 - 24 - 32 - 40 - This variable is used on horizontal video badges that contain a red play icon on top of a white square next to a timestamp. */
...
semanticLayoutCanvasWidthSizeWeb = 600
    ...
    public static let semanticLayoutGridLayoutGuideLayoutGuideGridColums = 8 /** Used to set the column count in Figma Layout guide Grids */
    ...
    public static let semanticSizeResponsiveSizeResp2Xl = 92 /** 72-72-92-100 – Use for setting height and width of UI elements that scale across breakpoints */
    ...
    public static let semanticSizeResponsiveSizeResp3Xl = 120 /** 96-96-120-148 – Use for setting height and width of UI elements that scale across breakpoints */
    ...
    public static let semanticSizeResponsiveSizeResp4Xl = 160 /** 148-148-160-180 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeResp4Xs = 14 /** 12-12-14-16 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeRespLg = 72 /** 56-56-72-92 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeRespMd = 64 /** 48-48-64-72 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeRespSm = 48 /** 40-40-48-56 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeRespXl = 80 /** 64-64-80-96 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeRespXs = 40 /** 32-32-40-48 – Use for setting height and width of UI elements that scale across breakpoints */
    ...
    public static let semanticSpaceGapResponsiveGapSpaceResp2Xl = 48 /** 32-32-48-64 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceResp2Xs = 4 /** 2-2-4-6 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceResp3Xl = 72 /** 48-48-72-96 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceRespLg = 24 /** 16-16-24-32 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceRespMd = 16 /** 12-12-16-24 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceRespSm = 12 /** 8-8-12-16 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceRespXl = 32 /** 24-24-32-48 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceRespXs = 6 /** 4-4-6-8 – Use for gaps between items inside of UI elements that scale across breakpoints */
    ...
    public static let semanticSpaceInlineResponsiveInlineSpaceResp2Xl = 48 /** 32-32-48-64 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceInlineResponsiveInlineSpaceRespLg = 24 /** 16-16-24-32 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceInlineResponsiveInlineSpaceRespMd = 16 /** 12-12-16-24 use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceInlineResponsiveInlineSpaceRespSm = 12 /** 8-8-12-16 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceInlineResponsiveInlineSpaceRespXl = 32 /** 24-24-32-40 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    ...
    public static let semanticSpaceStackResponsiveStackSpaceResp2Xl = 48 /** 32-32-48-64 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceStackResponsiveStackSpaceRespLg = 24 /** 16-16-24-32 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceStackResponsiveStackSpaceRespMd = 16 /** 12-12-16-24 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceStackResponsiveStackSpaceRespSm = 12 /** 8-8-12-16 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceStackResponsiveStackSpaceRespXl = 32 /** 24-24-32-40 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    ...
    public static let semanticTypographyFontSizeDisplayDisplay1FontSize = 72 /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    public static let semanticTypographyFontSizeDisplayDisplay2FontSize = 42 /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let semanticTypographyFontSizeDisplayDisplay3FontSize = 32 /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    public static let semanticTypographyFontSizeFootnoteFootnote1FontSize = 16 /** This token is used on the footnote text style font size parameter. 16 - 16 - 16 - 18 */
    public static let semanticTypographyFontSizeFootnoteFootnote2FontSize = 12 /** This token is used in the font size parameter of the footnote2 text style. 12 - 12 - 12 - 16 */
    public static let semanticTypographyFontSizeHeadlineHeadline1FontSize = 72 /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    public static let semanticTypographyFontSizeHeadlineHeadline2FontSize = 48 /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    public static let semanticTypographyFontSizeHeadlineHeadline3FontSize = 36 /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    ...
    public static let semanticTypographyFontSizeKickerKicker1FontSize = 22 /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    public static let semanticTypographyFontSizeKickerKicker2FontSize = 22 /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24 */
    public static let semanticTypographyFontSizeKickerKicker3FontSize = 18 /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 16 - 16 - 18 - 20 */
    ...
    public static let semanticTypographyFontSizeLabelLabel1FontSizeResponsive = 15 /** 10 - 10 - 15 - 17 Use this label font size when you want your label's font size to change across device sizes. */
    ...
    public static let semanticTypographyFontSizeQuoteQuoteFontSize = 18 /** 16 - 16 - 18 - 20 -- This variable is used for controlling the font size of the quote text style. */
    public static let semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 32 /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    public static let semanticTypographyFontSizeTitleTitle2FontSize = 18 /** 16 - 16 - 18 - 20 - html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
    ...
    public static let semanticTypographyLetterSpacingDisplayDisplay1LetterSpacing = -1 /** -0.5 | -0.5 | -1 | -2 | This variable is used for the letter spacing parameter of the display1 text style. On smaller devices the value is smaller than on larger devices. On desktop devices the letter spacing is further reduced for making the text style more compact. */
    ...
    public static let semanticTypographyLineHeightBodyBodyLineHeight = 28 /** Figma's font line height currently does not allow for multipliers as is used on current website css var(--body-line-height) */
    ...
    public static let semanticTypographyLineHeightFootnoteFootnote2LineHeight = 15.8
    public static let semanticTypographyLineHeightHeadlineHeadline1LineHeight = 72
    public static let semanticTypographyLineHeightHeadlineHeadline2LineHeight = 48
    public static let semanticTypographyLineHeightHeadlineHeadline3LineHeight = 36
    ...
    public static let semanticTypographyLineHeightKickerKicker2LineHeight = 22
    public static let semanticTypographyLineHeightKickerKicker3LineHeight = 18
    ...
    public static let semanticTypographyLineHeightLabelLabel1ResponsiveLineHeight = 15
    ...
    public static let semanticTypographyLineHeightQuoteQuoteLineHeight = 18 /** This variable is used in the quote text style line height parameter. */
    public static let semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = 32
    public static let semanticTypographyLineHeightTitleTitle1LineHeight = 22
    public static let semanticTypographyLineHeightTitleTitle2LineHeight = 19.8 /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
