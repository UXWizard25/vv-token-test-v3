...
public class {
    ...
    public static let componentArticleArticleHeadlineFontSize = 70 /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    public static let componentArticleArticleImageCaptionFontSize = 16 /** CSS --article-figure-meta-font-size 16-16-18-18 */
    public static let componentArticleArticleImageCaptionLineHeight = 24 /** this component level variable references the branding variables */
    ...
    public static let componentArticleArticleKickerFontSize = 25 /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    public static let componentTeaserATeaserATeaserKickerFontSize = 21 /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    ...
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontSize = 32 /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    ...
    public static let componentTeaserQTeaserQuadHeadlineFontSize = 70 /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
...
semanticLayoutCanvasWidthSizeWeb = 1024
    ...
    public static let semanticTypographyFontSizeDisplayDisplay1FontSize = 116 /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    public static let semanticTypographyFontSizeDisplayDisplay2FontSize = 62 /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let semanticTypographyFontSizeDisplayDisplay3FontSize = 39 /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    public static let semanticTypographyFontSizeHeadlineHeadline1FontSize = 70 /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    ...
    public static let semanticTypographyFontSizeHeadlineHeadline3FontSize = 32 /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    ...
    public static let semanticTypographyFontSizeKickerKicker1FontSize = 25 /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    public static let semanticTypographyFontSizeKickerKicker2FontSize = 21 /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24 */
    ...
    public static let semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 28 /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
