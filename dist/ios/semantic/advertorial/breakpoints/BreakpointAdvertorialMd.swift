...
public class {
    ...
    public static let componentArticleArticleHeadlineFontSize = 54 /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    public static let componentArticleArticleKickerFontSize = 18 /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    public static let componentTeaserATeaserATeaserHeadlineFontSize = 36 /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    public static let componentTeaserATeaserATeaserHeadlineLineHeight = 39.6
    public static let componentTeaserATeaserATeaserKickerFontSize = 18 /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    public static let componentTeaserATeaserATeaserKickerLineHeight = 18
    ...
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontSize = 26 /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700
    public static let componentTeaserMQTeaserMQTeaserHeadlineLineHeight = 28.6
    ...
    public static let componentTeaserQTeaserQuadHeadlineFontSize = 54 /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    public static let componentTeaserQTeaserQuadHeadlineLineHeight = 56.7
...
semanticLayoutCanvasWidthSizeWeb = 600
    ...
    public static let semanticTypographyFontSizeDisplayDisplay1FontSize = 70 /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    public static let semanticTypographyFontSizeDisplayDisplay2FontSize = 41 /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let semanticTypographyFontSizeDisplayDisplay3FontSize = 31 /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    public static let semanticTypographyFontSizeHeadlineHeadline1FontSize = 54 /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    public static let semanticTypographyFontSizeHeadlineHeadline2FontSize = 36 /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    public static let semanticTypographyFontSizeHeadlineHeadline3FontSize = 26 /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    public static let semanticTypographyFontSizeHeadlineHeadline4FontSize = 20 /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    public static let semanticTypographyFontSizeKickerKicker1FontSize = 18 /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    public static let semanticTypographyFontSizeKickerKicker2FontSize = 18 /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24 */
    ...
    public static let semanticTypographyLineHeightHeadlineHeadline1LineHeight = 56.7
    public static let semanticTypographyLineHeightHeadlineHeadline2LineHeight = 39.6
    public static let semanticTypographyLineHeightHeadlineHeadline3LineHeight = 28.6
    public static let semanticTypographyLineHeightHeadlineHeadline4LineHeight = 19.8
    ...
    public static let semanticTypographyLineHeightTitleTitle2LineHeight = 19.2 /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
