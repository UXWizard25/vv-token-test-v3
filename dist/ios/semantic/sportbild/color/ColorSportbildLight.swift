...
public class {
    ...
    public static let componentAvatarAvatarLabelColor = UIColor(red: 0.400, green: 0.420, blue: 0.439, alpha: 1) /** 09-2025 css --article-author-name-color */
    public static let componentAvatarAvatarLabelColorHover = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1) /** 09-2025 css --article-author-name-color */
    public static let componentBreadcrumbBreadcrumbTextColorHover = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1) /** Use this token on breadcrumbs that the user's pointer is hovering on or clicked on. This token changes color between light and dark modes. L:015 / D:100 */
    public static let componentBreadcrumbBreadcrumbTextColorIdle = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1) /** Use this token on breadcrumbs that are in their default idle state. This token changes color between light and dark modes. L:035 / D:096 */
    public static let componentBreakingNewsBreakingNewsBottomTitleTextColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1)
    public static let componentBreakingNewsBreakingNewsSurfaceColor = UIColor(red: 1.000, green: 0.749, blue: 0.000, alpha: 1)
    public static let componentBreakingNewsBreakingNewsTextContentColor = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1)
    public static let componentBreakingNewsBreakingNewsTitleSurfaceColor = UIColor(red: 0.039, green: 0.149, blue: 0.310, alpha: 1)
    public static let componentBreakingNewsBreakingNewsTopTitleTextColor = UIColor(red: 1.000, green: 0.749, blue: 0.000, alpha: 1)
    ...
    public static let componentButtonGhostButtonGhostBgColorHover = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1)
    public static let componentButtonPrimaryButtonPrimaryBrandBgColorHover = UIColor(red: 0.039, green: 0.149, blue: 0.310, alpha: 1)
    public static let componentButtonPrimaryButtonPrimaryBrandBgColorIdle = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1)
    public static let componentButtonPrimaryButtonPrimaryLabelColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1)
    public static let componentButtonPrimaryButtonPrimaryNeutralBgColorHover = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    public static let componentButtonPrimaryButtonPrimaryNeutralBgColorIdle = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1) /** Use this variable on the neutral color primary button. Tone changes between light and dark mode. Light mode Bild & SpoBi: Tone 015 ; Dark mode Bild & SpoBi: Tone 100 */
    ...
    public static let componentButtonSecondaryButtonSecondaryBgColorHover = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1)
    public static let componentButtonSecondaryButtonSecondaryBgColorIdle = UIColor(red: 0.910, green: 0.929, blue: 0.941, alpha: 1)
    public static let componentButtonSecondaryButtonSecondaryLabelColor = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    public static let componentButtonTertiaryButtonTertiaryBorderColorHover = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    public static let componentButtonTertiaryButtonTertiaryBorderColorIdle = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1)
    public static let componentButtonTertiaryButtonTertiaryLabelColor = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    public static let componentButtonTertiaryButtonTertiarySuccessBgColorHover = UIColor(red: 0.812, green: 0.961, blue: 0.890, alpha: 1)
    ...
    public static let componentChipsChipsBgColorActive = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1)
    public static let componentChipsChipsBgColorHover = UIColor(red: 0.690, green: 0.000, blue: 0.012, alpha: 1)
    public static let componentChipsChipsBgColorIdle = UIColor(red: 0.910, green: 0.929, blue: 0.941, alpha: 1)
    public static let componentChipsChipsLabelColorHover = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1)
    public static let componentChipsChipsLabelColorIdle = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1)
    ...
    public static let componentDSysDocDsDocSpacingItemBgColor = UIColor(red: 0.871, green: 0.000, blue: 0.000, alpha: 0.1)
    public static let componentDSysDocDsDocSpacingItemBorderColor = UIColor(red: 0.871, green: 0.000, blue: 0.000, alpha: 0.5)
    public static let componentDropdownDropdownBgColorHover = UIColor(red: 0.969, green: 0.980, blue: 0.988, alpha: 1)
    public static let componentDropdownDropdownBgColorIdle = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1)
    public static let componentEmptiesEmptiesBgColor = UIColor(red: 0.969, green: 0.980, blue: 0.988, alpha: 1)
    public static let componentEmptiesEmptiesLogoColor = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1)
    public static let componentFoldoutFoldoutLabelColorActive = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1)
    public static let componentFoldoutFoldoutLabelColorIdle = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    public static let componentGalleryAppImageLightboxGalleryBgColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 1)
    public static let componentHeyHeyDrawerSurfaceColor = UIColor(red: 0.969, green: 0.980, blue: 0.988, alpha: 1)
    public static let componentHeyHeyFavInputFieldSurfaceColor = UIColor(red: 0.910, green: 0.929, blue: 0.941, alpha: 1)
    public static let componentHeyHeyIconUtilColor = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    public static let componentHeyHeySeparatorColor = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1) /** This is the most used color for separators across Bild products. */
    public static let componentHeyHeyTextColor = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    ...
    public static let componentInputFieldInputFieldBorderColorActive = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    public static let componentInputFieldInputFieldBorderColorDark = UIColor(red: 0.549, green: 0.569, blue: 0.588, alpha: 1)
    public static let componentInputFieldInputFieldBorderColorDarkActive = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1)
    public static let componentInputFieldInputFieldBorderColorIdle = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1)
    ...
    public static let componentKickerStandardKickerBgColorOnSurface = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1)
    ...
    public static let componentMenuItemMenuItemBorderColorActive = UIColor(red: 0.039, green: 0.149, blue: 0.310, alpha: 1)
    public static let componentMenuItemMenuItemLabelColorPrimary = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    public static let componentMenuItemMenuItemLabelColorPrimaryActive = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1)
    ...
    public static let componentMenuMenuLinkLaneLabelColor = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1)
    public static let componentMenuMenuLinkLaneLabelColorActive = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1)
    public static let componentMenuMenuLinkLaneSurfaceColor = UIColor(red: 0.039, green: 0.149, blue: 0.310, alpha: 1)
    public static let componentMenuMenuScrolledSurfaceGradientColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.95) /** Used on a thin part at the top of header in navigation menu. */
    ...
    public static let componentPaginationPaginationElementColorActive = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1)
    public static let componentPaginationPaginationElementColorDefault = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1)
    ...
    public static let componentPaginationScrollBarTrackBgColor = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.1) /** Used as the background surface color scroll bars. Found on components that vertically or horizontally stack elements. */
    public static let componentPartnerLinksPartnerLinksBgColorActive = UIColor(red: 0.910, green: 0.929, blue: 0.941, alpha: 1) /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    ...
    public static let componentPartnerLinksPartnerLinksBorderColorActive = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1) /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    ...
    public static let componentPartnerLinksPartnerLinksContainerBorderColor = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1) /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    public static let componentSelectionSelectionBorderColor = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1) /** Checkboxes and Radio buttons use this variable for their border. */
    ...
    public static let componentSubheaderSubheadersColor = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1)
    public static let componentTabAppBottomTabBarBgColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1)
    public static let componentTabTabBgColorHover = UIColor(red: 0.910, green: 0.929, blue: 0.941, alpha: 1)
    public static let componentTabTabLabelColorActive = UIColor(red: 0.200, green: 0.239, blue: 0.251, alpha: 1)
    public static let componentTabTabLabelColorDefault = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    ...
    public static let componentTextLinkTextLinkColorPrimary = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1)
    public static let componentTextLinkTextLinkColorSecondary = UIColor(red: 0.549, green: 0.569, blue: 0.588, alpha: 1)
    public static let componentTextLinkTextLinkColorSecondaryActive = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1)
    public static let semanticAttentionAccentColorPrimary = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1) /** Primary accent color used to emphasize interactive or highlight elements such as links, selection states, or focus indicators. Adapts in Darkmode to a fully white tone. */
    public static let semanticAttentionAccentColorPrimaryConstant = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1) /** Used for accent highlights that must remain visually consistent across themes (e.g., brand identifiers, logos, or fixed emphasis areas). Color value does not change between Light and Dark mode. */
 ...
 */
semanticBorderBorderColorHighContrast = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1)
    public static let /**
 ...
 */
semanticBorderBorderColorLowContrast = UIColor(red: 0.910, green: 0.929, blue: 0.941, alpha: 1)
 ...
 */
semanticBorderBorderColorMediumContrast = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1)
    public static let semanticBorderBorderColorPrimaryDisabled = UIColor(red: 0.949, green: 0.961, blue: 0.961, alpha: 1) /** Applied to disabled states of primary elements (e.g., buttons, inputs) to visually reduce emphasis and indicate inactivity. */
    public static let semanticBorderBorderColorSecondaryDisabled = UIColor(red: 0.910, green: 0.929, blue: 0.941, alpha: 1) /** Used for secondary component borders in a disabled state (e.g., secondary buttons, inactive input outlines). */
    public static let /**
...
semanticBorderBorderColorWarning = UIColor(red: 0.871, green: 0.000, blue: 0.000, alpha: 1)
    public static let semanticCoreCoreColorPrimary = UIColor(red: 0.039, green: 0.149, blue: 0.310, alpha: 1) /** Used as the main brand color for key interactive elements such as primary buttons, active states, and prominent highlights. It remains constant across Light and Dark Mode. */
    ...
    public static let semanticCoreCoreColorTertiary = UIColor(red: 0.031, green: 0.090, blue: 0.161, alpha: 1) /** Represents tertiary brand accents. This variable changes across Light and Dark Mode. */
    public static let semanticCoreCoreColorTertiaryConstant = UIColor(red: 0.031, green: 0.090, blue: 0.161, alpha: 1) /** Use this on elements that need to maintain the dark color across themes and color modes. */
    public static let semanticCoreCoreColorTertiaryVvPipeTest = UIColor(red: 0.278, green: 0.431, blue: 0.580, alpha: 1) /** this is a test for the token pipeline */
    public static let semanticCoreFelipeTestColor = UIColor(red: 0.910, green: 0.341, blue: 0.039, alpha: 1) /** this is a test for the token pipeline */
    public static let semanticCoreNpmTest = UIColor(red: 0.278, green: 0.431, blue: 0.580, alpha: 1) /** this is a test for the token pipeline */
    public static let /**
 ...
 */
semanticHeadingHeadlineColorPrimary = UIColor(red: 0.039, green: 0.149, blue: 0.310, alpha: 1)
    public static let /**
 ...
 */
semanticIconIconColorInverse = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1)
    public static let semanticIconIconColorPrimary = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1) /** Primary icon color on primary surfaces. */
    public static let /**
 ...
 */
semanticLabelLabelColorDisabled = UIColor(red: 0.812, green: 0.831, blue: 0.851, alpha: 1)
    public static let /**
 ...
 */
semanticLabelLabelColorPrimary = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1)
    public static let /**
 ...
 * Behavior: Dynamic — switches between light and dark.
 */
semanticLabelLabelColorPrimaryInverse = UIColor(red: 0.910, green: 0.929, blue: 0.941, alpha: 1)
    public static let /**
 ...
 */
semanticLabelLabelColorSecondary = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    public static let /**
 ...
 */
semanticStateColorPrimaryActive = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1)
    public static let /**
 ...
 */
semanticStateColorPrimaryDisabled = UIColor(red: 0.949, green: 0.961, blue: 0.961, alpha: 1)
    public static let /**
 ...
 */
semanticStateColorSecondaryActive = UIColor(red: 0.141, green: 0.149, blue: 0.161, alpha: 1)
    public static let /**
 ...
 */
semanticStateColorSecondaryActiveInverse = UIColor(red: 0.949, green: 0.961, blue: 0.961, alpha: 1)
    public static let /**
 ...
 */
semanticStateColorSecondaryDisabled = UIColor(red: 0.910, green: 0.929, blue: 0.941, alpha: 1)
    public static let /**
 ...
 */
semanticSurfaceSurfaceColorPrimaryConstantDark = UIColor(red: 0.031, green: 0.090, blue: 0.161, alpha: 1)
    public static let /**
 ...
 */
semanticSurfaceSurfaceColorQuartenaryInverse = UIColor(red: 0.290, green: 0.322, blue: 0.349, alpha: 1)
    public static let /**
 ...
 */
semanticSurfaceSurfaceColorSecondary = UIColor(red: 0.969, green: 0.980, blue: 0.988, alpha: 1)
    public static let /**
 ...
 */
semanticSurfaceSurfaceColorSecondaryGradientStop = UIColor(red: 0.949, green: 0.961, blue: 0.961, alpha: 0)
    public static let /**
 ...
 */
semanticSurfaceSurfaceColorTertiary = UIColor(red: 0.741, green: 0.788, blue: 0.859, alpha: 1)
    public static let /**
 * Represents tertiary-level gradient background.
 * Currently used on skeletons.
 */
semanticSurfaceSurfaceColorTertiaryGradientStop = UIColor(red: 0.910, green: 0.929, blue: 0.941, alpha: 0)
    public static let /**
 ...
 */
semanticSurfaceSurfaceColorTertiaryInverse = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1)
    public static let semanticTextTextColorAccent = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1) /** Accent text color used for links, interactive text, or highlighted key words. Changes from a red in light mode to a white in dark mode. */
    public static let /**
 ...
 */
semanticTextTextColorAccentConstant = UIColor(red: 0.090, green: 0.271, blue: 0.510, alpha: 1)
    public static let /**
