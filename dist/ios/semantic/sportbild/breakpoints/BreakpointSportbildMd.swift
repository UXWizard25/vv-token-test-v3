...
public class {
    ...
    public static let componentArticleArticleHeadlineFontSize = 60 /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    public static let componentArticleArticleKickerFontSize = 26 /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    public static let componentTeaserATeaserATeaserHeadlineFontSize = 44 /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    ...
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontSize = 30 /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    ...
    public static let componentTeaserQTeaserQuadHeadlineFontSize = 60 /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
...
semanticLayoutCanvasWidthSizeWeb = 600
    ...
    public static let semanticTypographyFontSizeDisplayDisplay1FontSize = 68 /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    public static let semanticTypographyFontSizeDisplayDisplay2FontSize = 40 /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let semanticTypographyFontSizeDisplayDisplay3FontSize = 30 /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    public static let semanticTypographyFontSizeHeadlineHeadline1FontSize = 60 /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    public static let semanticTypographyFontSizeHeadlineHeadline2FontSize = 44 /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    ...
    public static let semanticTypographyFontSizeKickerKicker1FontSize = 26 /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    ...
    public static let semanticTypographyFontSizeSubheadlineSubheadline1FontSize = 22 /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    public static let semanticTypographyLineHeightQuoteQuoteLineHeight = 23.4 /** This variable is used in the quote text style line height parameter. */
    ...
    public static let semanticTypographyLineHeightTitleTitle2LineHeight = 23.4 /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
