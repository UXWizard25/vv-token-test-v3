...
public class {
    ...
    public static let componentDSysDocsDSysDocsWidthSize = 750
    ...
    public static let componentDSysDocsMainContentStageSize = 750 /** This variable is used as a max width size for content blocks. For mobile devices this var references the DSysDocsWidthSize var 320 - 750 - 962 - 1024 */
    ...
    public static let componentTabsAppsTabsLabelFontSize = 12 /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
...
semanticLayoutCanvasWidthSizeWeb = 390
    ...
    public static let semanticTypographyLineHeightTitleTitle2LineHeight = 20.8 /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
