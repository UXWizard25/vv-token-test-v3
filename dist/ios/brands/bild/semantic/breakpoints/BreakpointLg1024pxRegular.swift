...
//
// BreakpointLg1024pxRegular.swift
//
...
public class BreakpointLg1024pxRegular {
    ...
    public static let AvatarLabelFontSize = "18px"
    ...
    public static let ATeaserKickerFontSize = "24px"
    /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    public static let ATeaserHeadlineFontSize = "64px"
    public static let ATeaserKickerLineHeight = "24px"
    public static let ATeaserHeadlineLineHeight = "64px"
    ...
    public static let MQTeaserHeadlineFontSize = "40px"
    public static let MQTeaserHeadlineFontWeight = 700
    public static let MQTeaserHeadlineLineHeight = "40px"
    ...
    public static let QuadHeadlineFontSize = "100px"
    public static let QuadKickerFontSize = "24px"
    public static let QuadHeadlineLineHeight = "100px"
...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    ...
    public static let Kicker1FontSize = "30px"
    ...
    public static let Kicker2FontSize = "24px"
    ...
    public static let Kicker3FontSize = "20px"
    ...
    public static let Subheadline1FontSize = "36px"
    ...
    public static let Title1FontSize = "28px"
    ...
    public static let BodyLineHeight = "32px"
    ...
    public static let Footnote1LineHeight = "23px"
    public static let Footnote2LineHeight = "21px"

    // MARK: - Semantic - Typography - LineHeight - Headline
    public static let Headline1LineHeight = "100px"
    public static let Headline2LineHeight = "64px"
    public static let Headline3LineHeight = "40px"
    public static let Headline4LineHeight = "30px"

    // MARK: - Semantic - Typography - LineHeight - Kicker
    public static let Kicker4LineHeight = "16px"
    public static let Kicker3LineHeight = "20px"
    public static let Kicker2LineHeight = "24px"
    public static let Kicker1LineHeight = "30px"
    ...
    public static let Label1ResponsiveLineHeight = "17px"
