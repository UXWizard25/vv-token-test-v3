...
public class BreakpointLg1024pxRegular {
    ...
    public static let componentArticleArticleHeadlineFontSize = CGFloat(1600.00) /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    public static let componentArticleArticleImageSourceFontSize = CGFloat(288.00) /** NMT CSS --article-figure-meta-font-size */
    public static let componentArticleArticleImageSourceLineHeight = CGFloat(368.00)
    ...
    public static let componentArticleArticleKickerFontSize = CGFloat(480.00) /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    public static let componentAvatarAvatarLabelFontSize = CGFloat(288.00) /** This variable is used on avatar names in article pages. Bild: 16 - 16 - 16 - 18; SpoBi&Ads: 13 - 13 - 13 - 15 */
    ...
    public static let componentBreadcrumbBreadcrumbFontSize = CGFloat(192.00) /** 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices. */
    ...
    public static let componentBreadcrumbBreadcrumbLineHeight = CGFloat(192.00) /** 15 - 15 - 15 - 12 -- Breadcrumbs have a slightly larger font size on mobile devices compared to when they are rendered on larger desktop devices. */
    ...
    public static let componentTeaserATeaserATeaserHeadlineFontSize = CGFloat(1024.00) /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    public static let componentTeaserATeaserATeaserHeadlineLineHeight = CGFloat(1024.00)
    public static let componentTeaserATeaserATeaserKickerFontSize = CGFloat(384.00) /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    public static let componentTeaserATeaserATeaserKickerLineHeight = CGFloat(384.00)
    ...
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontSize = CGFloat(640.00) /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700
    public static let componentTeaserMQTeaserMQTeaserHeadlineLineHeight = CGFloat(640.00)
    ...
    public static let componentTeaserQTeaserQuadHeadlineFontSize = CGFloat(1600.00) /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    public static let componentTeaserQTeaserQuadHeadlineLineHeight = CGFloat(1600.00)
    public static let componentTeaserQTeaserQuadKickerFontSize = CGFloat(384.00)
...
semanticLayoutCanvasWidthSizeWeb = CGFloat(16384.00)
    ...
    public static let semanticTypographyFontSizeDisplayDisplay1FontSize = CGFloat(1920.00) /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    public static let semanticTypographyFontSizeDisplayDisplay2FontSize = CGFloat(1024.00) /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let semanticTypographyFontSizeDisplayDisplay3FontSize = CGFloat(640.00) /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    public static let semanticTypographyFontSizeFootnoteFootnote1FontSize = CGFloat(288.00) /** This token is used on the footnote text style font size parameter. 16 - 16 - 16 - 18 */
    public static let semanticTypographyFontSizeFootnoteFootnote2FontSize = CGFloat(256.00) /** This token is used in the font size parameter of the footnote2 text style. 12 - 12 - 12 - 16 */
    public static let semanticTypographyFontSizeHeadlineHeadline1FontSize = CGFloat(1600.00) /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    public static let semanticTypographyFontSizeHeadlineHeadline2FontSize = CGFloat(1024.00) /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    public static let semanticTypographyFontSizeHeadlineHeadline3FontSize = CGFloat(640.00) /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    public static let semanticTypographyFontSizeHeadlineHeadline4FontSize = CGFloat(512.00) /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    public static let semanticTypographyFontSizeKickerKicker1FontSize = CGFloat(480.00) /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    public static let semanticTypographyFontSizeKickerKicker2FontSize = CGFloat(384.00) /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24 */
    ...
    public static let semanticTypographyFontSizeSubheadlineSubheadline1FontSize = CGFloat(576.00) /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    public static let semanticTypographyLineHeightBodyBodyLineHeight = CGFloat(512.00) /** Figma's font line height currently does not allow for multipliers as is used on current website css var(--body-line-height) */
    ...
    public static let semanticTypographyLineHeightFootnoteFootnote1LineHeight = CGFloat(368.00)
    public static let semanticTypographyLineHeightFootnoteFootnote2LineHeight = CGFloat(336.00)
    public static let semanticTypographyLineHeightHeadlineHeadline1LineHeight = CGFloat(1600.00)
    public static let semanticTypographyLineHeightHeadlineHeadline2LineHeight = CGFloat(1024.00)
    public static let semanticTypographyLineHeightHeadlineHeadline3LineHeight = CGFloat(640.00)
    public static let semanticTypographyLineHeightHeadlineHeadline4LineHeight = CGFloat(480.00)
    public static let semanticTypographyLineHeightKickerKicker1LineHeight = CGFloat(480.00)
    public static let semanticTypographyLineHeightKickerKicker2LineHeight = CGFloat(384.00)
    public static let semanticTypographyLineHeightKickerKicker3LineHeight = CGFloat(320.00)
    public static let semanticTypographyLineHeightKickerKicker4LineHeight = CGFloat(256.00)
    ...
    public static let semanticTypographyLineHeightLabelLabel1ResponsiveLineHeight = CGFloat(272.00)
    ...
    public static let semanticTypographyLineHeightQuoteQuoteLineHeight = CGFloat(352.00) /** This variable is used in the quote text style line height parameter. */
    public static let semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = CGFloat(576.00)
    public static let semanticTypographyLineHeightTitleTitle1LineHeight = CGFloat(448.00)
    public static let semanticTypographyLineHeightTitleTitle2LineHeight = CGFloat(352.00) /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
