...
public class BreakpointMd600px {
    ...
    public static let componentArticleArticleHeadlineFontSize = CGFloat(1152.00) /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    public static let componentArticleArticleImageCaptionFontSize = CGFloat(288.00) /** CSS --article-figure-meta-font-size 16-16-18-18 */
    public static let componentArticleArticleImageCaptionLineHeight = CGFloat(396.00) /** this component level variable references the branding variables */
    ...
    public static let componentArticleArticleKickerFontSize = CGFloat(352.00) /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    public static let componentTeaserATeaserATeaserHeadlineFontSize = CGFloat(768.00) /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    public static let componentTeaserATeaserATeaserHeadlineLineHeight = CGFloat(768.00)
    public static let componentTeaserATeaserATeaserKickerFontSize = CGFloat(352.00) /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    public static let componentTeaserATeaserATeaserKickerLineHeight = CGFloat(352.00)
    ...
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontSize = CGFloat(576.00) /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700
    public static let componentTeaserMQTeaserMQTeaserHeadlineLineHeight = CGFloat(576.00)
    ...
    public static let componentTeaserQTeaserQuadHeadlineFontSize = CGFloat(1152.00) /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    public static let componentTeaserQTeaserQuadHeadlineLineHeight = CGFloat(1152.00)
    public static let componentTeaserQTeaserQuadKickerFontSize = CGFloat(352.00)
...
semanticLayoutCanvasWidthSizeWeb = CGFloat(9600.00)
    ...
    public static let semanticTypographyFontSizeDisplayDisplay1FontSize = CGFloat(1152.00) /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    public static let semanticTypographyFontSizeDisplayDisplay2FontSize = CGFloat(672.00) /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let semanticTypographyFontSizeDisplayDisplay3FontSize = CGFloat(512.00) /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    public static let semanticTypographyFontSizeHeadlineHeadline1FontSize = CGFloat(1152.00) /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    public static let semanticTypographyFontSizeHeadlineHeadline2FontSize = CGFloat(768.00) /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    public static let semanticTypographyFontSizeHeadlineHeadline3FontSize = CGFloat(576.00) /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    ...
    public static let semanticTypographyFontSizeKickerKicker1FontSize = CGFloat(352.00) /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    public static let semanticTypographyFontSizeKickerKicker2FontSize = CGFloat(352.00) /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24 */
    public static let semanticTypographyFontSizeKickerKicker3FontSize = CGFloat(288.00) /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 16 - 16 - 18 - 20 */
    ...
    public static let semanticTypographyFontSizeSubheadlineSubheadline1FontSize = CGFloat(512.00) /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    public static let semanticTypographyLineHeightCalloutCalloutLineHeight = CGFloat(352.00)
    ...
    public static let semanticTypographyLineHeightFootnoteFootnote2LineHeight = CGFloat(252.80)
    public static let semanticTypographyLineHeightHeadlineHeadline1LineHeight = CGFloat(1152.00)
    public static let semanticTypographyLineHeightHeadlineHeadline2LineHeight = CGFloat(768.00)
    public static let semanticTypographyLineHeightHeadlineHeadline3LineHeight = CGFloat(576.00)
    ...
    public static let semanticTypographyLineHeightKickerKicker2LineHeight = CGFloat(352.00)
    public static let semanticTypographyLineHeightKickerKicker3LineHeight = CGFloat(288.00)
    ...
    public static let semanticTypographyLineHeightQuoteQuoteLineHeight = CGFloat(288.00) /** This variable is used in the quote text style line height parameter. */
    public static let semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = CGFloat(512.00)
    public static let semanticTypographyLineHeightTitleTitle1LineHeight = CGFloat(352.00)
    public static let semanticTypographyLineHeightTitleTitle2LineHeight = CGFloat(316.80) /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
