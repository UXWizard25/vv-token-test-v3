...
public class BreakpointMd600px {
    ...
    public static let ArticleImageCaptionFontSize = "18px"
    ...
    public static let ArticleImageCaptionLineHeight = "24.75px"
    ...
    public static let TableColumnWidthSize0_5x = "48px"
    public static let TableColumnWidthSize1_5x = "160px"
    public static let TableColumnWidthSize2_5x = "240px"
    public static let TableColumnWidthSize0_75x = "64px"
    ...
    public static let ATeaserKickerFontSize = "22px"
    /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    public static let ATeaserHeadlineFontSize = "48px"
    public static let ATeaserKickerLineHeight = "22px"
    public static let ATeaserHeadlineLineHeight = "48px"
    ...
    public static let MQTeaserHeadlineFontSize = "36px"
    public static let MQTeaserHeadlineFontWeight = 700
    public static let MQTeaserHeadlineLineHeight = "36px"
    ...
    public static let QuadHeadlineFontSize = "72px"
    public static let QuadKickerFontSize = "22px"
    public static let QuadHeadlineLineHeight = "72px"
...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    ...
    public static let Kicker1FontSize = "22px"
    ...
    public static let Kicker2FontSize = "22px"
    ...
    public static let Kicker3FontSize = "18px"
    ...
    public static let Kicker4FontSize = "16px"
    ...
    public static let Title2FontSize = "18px"
    ...
    public static let CalloutLineHeight = "22px"
    ...
    public static let Footnote2LineHeight = "15.800000190734863px"

    // MARK: - Semantic - Typography - LineHeight - Headline
    public static let Headline1LineHeight = "72px"
    public static let Headline2LineHeight = "48px"
    public static let Headline3LineHeight = "36px"
    public static let Headline4LineHeight = "22px"

    // MARK: - Semantic - Typography - LineHeight - Kicker
    public static let Kicker4LineHeight = "17.600000381469727px"
    public static let Kicker3LineHeight = "18px"
    public static let Kicker2LineHeight = "22px"
    ...
    public static let QuoteLineHeight = "18px"

    // MARK: - Semantic - Typography - LineHeight - Subheadline
    public static let Subheadline1LineHeight = "32px"
    ...
    public static let Title2LineHeight = "19.799999237060547px"
