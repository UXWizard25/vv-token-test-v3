...
public class BreakpointXs320px {
    ...
    public static let ArticleTopMarginSpace = "8px"
    ...
    public static let ArticleHeadlineFontSize = "40px"
    /** same as standard teaser width size variable */
    public static let ArticleGalleryATeaserWidth = "145px"
    ...
    public static let ArticleContentStackSpace = "16px"
    ...
    public static let ArticleImageLandscapeInlineSpace = "0px"
    ...
    public static let ArticleMetaFontFamily = "Gotham"
    ...
    public static let ArticleMetaFontSize = "12px"
    ...
    public static let ArticleContentInlineSpace = "16px"
    ...
    public static let ArticleImagePortaitInlineSpace = "0px"
    public static let ArticleImageContainerStackSpace = "8px"
    ...
    public static let AvatarLabelFontSize = "16px"
    ...
    public static let AvatarAuthorPageSize = "96px"
    ...
    public static let InputFieldFontFamily = "Gotham XNarrow"
    ...
    public static let LiveTickerHeadlinesFontSize = "22px"
    ...
    public static let LiveTickerTimeStampFontSize = "14px"
    ...
    public static let NewsTickerTimeFontFamily = "Gotham XNarrow"
    ...
    public static let NewsTickerTime&KickerStackSpace = "4px"
    ...
    public static let GalleryPaginationContainerWebInlineSpace = "8px"
    /** 12 - 12 - 16 - 16 - this component level variable references the semantic */
    public static let GalleryPaginationContainerStackSpace = "12px"
    ...
    public static let SectionTitle&ArrowInlineSpaceActive = "5px"
    ...
    public static let ArticleSkeletonImageInlineSpace = "12px"
    ...
    public static let VideoSpinnerSize0_5x = "20px"

    // MARK: - Component - Table
    public static let TableColumnWidthSize1x = "80px"
    public static let TableColumnWidthSize2x = "140px"
    public static let TableColumnWidthSize0_5x = "40px"
    public static let TableColumnWidthSize1_5x = "120px"
    public static let TableColumnWidthSize2_5x = "180px"
    public static let TableColumnWidthSize0_75x = "56px"
    ...
    public static let AndroidTabbarHeightSize = "56px"
    /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    public static let TabLabelFontSizeLine = "12px"
    /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    public static let AppsTabsLabelFontSize = "11px"
    /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    ...
    public static let ATeaserHeadlineFontSize = "28px"
    public static let ATeaserKickerLineHeight = "16px"
    public static let ATeaserHeadlineLineHeight = "28px"
    ...
    public static let MQTeaserHeadlineFontSize = "22px"
    public static let MQTeaserHeadlineFontWeight = 600
    public static let MQTeaserHeadlineLineHeight = "22px"
    ...
    public static let QuadHeadlineFontSize = "48px"
    public static let QuadKickerFontSize = "18px"
    public static let QuadHeadlineLineHeight = "48px"
    ...
    public static let AppToggleItemLabelFontSize = "14px"
    ...
    public static let DSysDocsWidthSize = "320px"
    ...
    public static let MainContentStageSize = "320px"
...
Apply this token to the main frame of page layouts to simulate realistic vertical space. */
    public static let CanvasHeightSizeWeb = "568px"
    /** Common viewport width size based on the selected breakpoint.
Apply this token to the main frame of page layouts. */
    public static let CanvasWidthSizeWeb = "320px"
    /** Common viewport width size based on the selected breakpoint.
Apply this token to the main frame of page layouts. */
    public static let CanvasWidthSizeApp = "320px"
    /** Common viewport height size based on the selected mode.
Apply this token to the main frame of page layouts to simulate realistic vertical space. */
    public static let CanvasHeightSizeApp = "568px"
...
Apply this token to the main frame of page layouts to simulate realistic minimum widths across responsive viewports. */
    public static let BreakpointMinWidthSize = "320px"
...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    public static let BreakpointMaxWidthSize = "389px"
    ...
    public static let BodyFontSize = "21px"
    ...
    public static let Label1FontSizeResponsive = "10px"
    ...
    public static let Subheadline1FontSize = "24px"
    ...
    public static let LetterSpacingNegativeSM = "-0.5px"
    /** -1 | -1 | -1 | -1 | This variable takes primitive letter spacing variables and creates this semantic variable for use on designs that change across device sizes. */
    ...
    public static let Display1LetterSpacing = "-0.5px"
    ...
    public static let Display2LetterSpacing = "-0.5px"
    ...
    public static let BodyLineHeight = "28px"

    // MARK: - Semantic - Typography - LineHeight - Callout
    public static let CalloutLineHeight = "18px"
    ...
    public static let Footnote1LineHeight = "21px"
    public static let Footnote2LineHeight = "15.600000381469727px"

    // MARK: - Semantic - Typography - LineHeight - Headline
    public static let Headline1LineHeight = "48px"
    public static let Headline2LineHeight = "40px"
    public static let Headline3LineHeight = "28px"
    public static let Headline4LineHeight = "22px"
    ...
    public static let VisilbleAbove600px = false
    /** Use for showing elements on viewport sizes below 600 px */
    public static let VisilbleBelow600px = true
    /** Use for hiding elements on mobile viewport sizes */
    public static let HideOnMobile = false
