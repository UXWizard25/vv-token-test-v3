...
public class BreakpointXs320px {
    ...
    public static let componentDSysDocsDSysDocsWidthSize = CGFloat(5120.00)
    ...
    public static let componentDSysDocsMainContentStageSize = CGFloat(5120.00) /** This variable is used as a max width size for content blocks. For mobile devices this var references the DSysDocsWidthSize var 320 - 750 - 962 - 1024 */
    ...
    public static let componentTabsAppsTabsLabelFontSize = CGFloat(176.00) /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
 ...
 */
semanticLayoutBreakpointsBreakpointMaxWidthSize = CGFloat(6224.00)
    public static let /**
 ...
 */
semanticLayoutBreakpointsBreakpointMinWidthSize = CGFloat(5120.00)
    public static let /**
 ...
 */
semanticLayoutCanvasHeightSizeApp = CGFloat(9088.00)
    public static let /**
 * Common viewport height size based on the selected mode.
 * Apply this token to the main frame of page layouts to simulate realistic vertical space.
 */
semanticLayoutCanvasHeightSizeWeb = CGFloat(9088.00)
    public static let /**
 * Common viewport width size based on the selected breakpoint.
 * Apply this token to the main frame of page layouts.
 */
semanticLayoutCanvasWidthSizeApp = CGFloat(5120.00)
    public static let /**
 * Common viewport width size based on the selected breakpoint.
 * Apply this token to the main frame of page layouts.
 */
semanticLayoutCanvasWidthSizeWeb = CGFloat(5120.00)
