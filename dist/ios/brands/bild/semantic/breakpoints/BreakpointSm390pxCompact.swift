...
public class BreakpointSm390pxCompact {
    ...
    public static let componentArticleAricleMobile1ColGridImageMarginSpace = CGFloat(0.00)
    public static let componentArticleArticleContentInlineSpace = CGFloat(256.00) /** 16 | 16 | 72 | 162 - This variable is used for making the left and right spacings around article content blocks. Current css has the article-body class assigned to a div and article body contains these horizontal padding values. */
    public static let componentArticleArticleContentStackSpace = CGFloat(256.00) /** 16 - 16 - 24 - 32 - This variable creates the vertical spacing between different article body elements such as avatars, media players, corssheadings, paragraphs, field sets, images, tables, quotes, videos, social embeds, etc. */
    public static let componentArticleArticleGalleryATeaserWidth = CGFloat(2320.00) /** same as standard teaser width size variable */
    ...
    public static let componentArticleArticleHeadlineFontSize = CGFloat(640.00) /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    public static let componentArticleArticleImageCaptionFontSize = CGFloat(256.00) /** CSS --article-figure-meta-font-size 16-16-18-18 */
    ...
    public static let componentArticleArticleImageContainerStackSpace = CGFloat(128.00)
    public static let componentArticleArticleImageLandscapeInlineSpace = CGFloat(0.00)
    public static let componentArticleArticleImagePortaitInlineSpace = CGFloat(0.00)
    public static let componentArticleArticleImageSourceFontSize = CGFloat(256.00) /** NMT CSS --article-figure-meta-font-size */
    public static let componentArticleArticleImageSourceLineHeight = CGFloat(336.00)
    public static let componentArticleArticleInfoboxInlineSpace = CGFloat(256.00)
    public static let componentArticleArticleInfoboxStackSpace = CGFloat(256.00)
    ...
    public static let componentArticleArticleMetaFontSize = CGFloat(192.00) /** This variable is used on the font size of article day&time stamp that usually shows up along with the article author avatars. On app versions this variable is used for the avatar names. 12 - 12 - 14 - 16 */
    public static let componentArticleArticleTopMarginSpace = CGFloat(128.00) /** 8 | 8 | 12 | 16 - This space variable is used at the top edge of the article main content bounding box. */
    ...
    public static let componentAvatarAvatarAuthorPageSize = CGFloat(1536.00) /** 96 - 96 - 130 - 130 This variable is used for controlling the size of the avatar image on author pages. */
    ...
    public static let componentAvatarAvatarLabelFontSize = CGFloat(256.00) /** This variable is used on avatar names in article pages. Bild: 16 - 16 - 16 - 18; SpoBi&Ads: 13 - 13 - 13 - 15 */
    ...
    public static let componentAvatarAvatarLaneGapSpace = CGFloat(256.00) /** This variable is used for setting the inline space between multiple avatars that are horizontally placed in a lane when an article has multiple authors. 16 - 16 - 24 - 24 */
    ...
    public static let componentBreakingNewsBreakingNewsBadgeInlineSpace = CGFloat(96.00)
    public static let componentBreakingNewsBreakingNewsBadgeLowerTitleFontSize = CGFloat(368.00)
    public static let componentBreakingNewsBreakingNewsBadgeLowerTitleLineHeight = CGFloat(336.00)
    public static let componentBreakingNewsBreakingNewsBadgeTitelsStackSpace = CGFloat(0.00)
    public static let componentBreakingNewsBreakingNewsBadgeUpperTitleFontSize = CGFloat(208.00)
    public static let componentBreakingNewsBreakingNewsBadgeUpperTitleLineHeight = CGFloat(208.00)
    ...
    public static let componentCarouselAppEpaperCarouseBeilageItemWidth = CGFloat(1760.00)
    public static let componentCarouselAppEpaperCarouselItemDefaultWidth = CGFloat(2304.00)
    public static let componentCarouselAppEpaperCarouselItemFocusWidth = CGFloat(2912.00)
    public static let componentCarouselGalleryTeaserAppGapSpace = CGFloat(0.00) /** This token is used to create more bottom padding space on system teaser headlines inside the gallery to avoid overlapping with the pagination. */
    public static let componentCarouselGalleryTeaserTitleBottomSpace = CGFloat(448.00) /** This token is used to create more bottom padding space on system teaser headlines inside the gallery to avoid overlapping with the pagination. */
    public static let componentCarouselStandardTeaserGalleryTeaserWidthApp = CGFloat(4480.00)
    public static let componentCarouselStandardTeaserGalleryTeaserWidthWeb = CGFloat(2320.00)
    ...
    public static let componentDSysDocs1columnMobile = CGFloat(5120.00) /** This variable is used only for this design system's component tests. */
    public static let componentDSysDocsBildDesignFrameSpace = CGFloat(192.00) /** Variable used in spacing parameters of bild.design webpage mockups. move to bild.design group maybe */
    public static let componentDSysDocsDSysDocsWidthSize = CGFloat(12000.00)
    public static let componentDSysDocsDocHeaderHeightSize = CGFloat(2304.00) /** This variable is used on documentation headers that contain info about platfroms and component names. 144 - 144 - 160 - 180 */
    public static let componentDSysDocsDsCaptionStackSpace05x = CGFloat(64.00) /** This variable is used in documentation pages that have small caption or lables along with a UI component documented. 4 - 4 - 6 - 8 */
    public static let componentDSysDocsDsCaptionStackSpace1x = CGFloat(128.00)
    public static let componentDSysDocsDsMainContainerSpace = CGFloat(0.00) /** This variable is used on documentation pages. This is an alternative variable to the main container max width variable. 0 - 0 - 68 - 68 */
    ...
    public static let componentDSysDocsMainContentStageSize = CGFloat(12000.00) /** This variable is used as a max width size for content blocks. For mobile devices this var references the DSysDocsWidthSize var 320 - 750 - 962 - 1024 */
    ...
    public static let componentInfoElementInfoElementTeaserImageHeightSize = CGFloat(1280.00)
    public static let componentInfoElementInfoElementTeaserImageWidthSize = CGFloat(1280.00)
    ...
    public static let componentLivetickerLiveTickerAppCardHeightSize = CGFloat(1536.00)
    public static let componentLivetickerLiveTickerAppCardWidthSize = CGFloat(4000.00)
    public static let componentLivetickerLiveTickerHeadlinesFontSize = CGFloat(352.00) /** This variable is used for the font size of live ticker headlines. 22 - 22 - 32 - 32 */
    ...
    public static let componentLivetickerLiveTickerTimeStampFontSize = CGFloat(224.00) /** This variable is used for the live ticker time stamp font size. 14 - 14 - 16 - 16 */
    ...
    public static let componentMediaplayerVidPlayerTimecodeContainerMinWidthSize = CGFloat(720.00)
    public static let componentMediaplayerVidPlayerTimecodeFontSize = CGFloat(224.00)
    ...
    public static let componentMenuAppTopbarStageTitleHeight = CGFloat(224.00)
    public static let componentMenuAppTopbarTitleFontSize = CGFloat(192.00)
    ...
    public static let componentMenuIOSappTopBarHeightSize = CGFloat(704.00)
    public static let componentMenuIOSappTopBarLeftInlineSpace = CGFloat(192.00)
    public static let componentMenuIOSappTopBarRightInlineSpace = CGFloat(256.00)
    ...
    public static let componentNewstickerNewsTickerAppCardHeightSize = CGFloat(1856.00)
    public static let componentNewstickerNewsTickerAppCardWidthSize = CGFloat(4000.00)
    public static let componentNewstickerNewsTickerBadgesInlineSpace = CGFloat(128.00)
    ...
    public static let componentNewstickerNewsTickerLineInlineSpace = CGFloat(96.00)
    public static let componentNewstickerNewsTickerRedDotSize = CGFloat(192.00)
    public static let componentNewstickerNewsTickerSkeletonBottomSpace = CGFloat(1024.00)
    ...
    public static let componentNewstickerNewsTickerTimeKickerStackSpace = CGFloat(64.00)
    ...
    public static let componentNewstickerNewsTickerTitlesInlineSpace = CGFloat(288.00)
    public static let componentPaginationGalleryPaginationContainerAppInlineSpace = CGFloat(192.00)
    public static let componentPaginationGalleryPaginationContainerStackSpace = CGFloat(192.00) /** 12 - 12 - 16 - 16 - this component level variable references the semantic */
    public static let componentPaginationGalleryPaginationContainerWebInlineSpace = CGFloat(128.00) /** 8 - 8 - 12 - 12 - this component level variable references the inlineSpaceConst semantic variables; SM for smaller devices, MD for larger devices */
    ...
    public static let componentQuotesQuoteContainerStackSpace = CGFloat(256.00)
    public static let componentQuotesQuoteContentGapSpace = CGFloat(256.00)
    public static let componentQuotesQuoteQuotationMarksFontSize = CGFloat(448.00)
    ...
    public static let componentSkeletonsArticleSkeletonImageInlineSpace = CGFloat(192.00)
    public static let componentSkeletonsArticleSkeletonTextInlineSpace = CGFloat(0.00)
    public static let componentSkeletonsArticleTextSkeletonHeightSize = CGFloat(4320.00)
    public static let componentSkeletonsHeadlinesSkeletonImagePlaceholderMaxWidth = CGFloat(4512.00)
    ...
    public static let componentSpinnersVideoSpinnerSize = CGFloat(640.00)
    public static let componentSpinnersVideoSpinnerSize05x = CGFloat(320.00)
    public static let componentSpinnersVideoSpinnerStrokeSize = CGFloat(32.00)
    public static let componentTableTableColumnWidthSize05x = CGFloat(640.00)
    public static let componentTableTableColumnWidthSize075x = CGFloat(896.00)
    public static let componentTableTableColumnWidthSize15x = CGFloat(1920.00)
    public static let componentTableTableColumnWidthSize1x = CGFloat(1280.00)
    public static let componentTableTableColumnWidthSize25x = CGFloat(2880.00)
    public static let componentTableTableColumnWidthSize2x = CGFloat(2240.00)
    public static let componentTableTableColumnWidthSize3x = CGFloat(3200.00)
    public static let componentTableTableItemMaxWidthSize = CGFloat(3584.00)
    public static let componentTabsAndroidTabbarHeightSize = CGFloat(896.00)
    public static let componentTabsAppsTabsLabelFontSize = CGFloat(192.00) /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    public static let componentTabsAppsTabsLabelLineHeight = CGFloat(230.40) /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    ...
    public static let componentTabsTabLabelFontSizeLine = CGFloat(192.00) /** Tab labels font size remain constant at 16px across devices and breakpoints. This behavior can be seen on the Mein Konto page tabs for purchases and payment data. */
    public static let componentTabsTopBarTabItemHeightSize = CGFloat(704.00)
    public static let componentTeaserATeaserATeaserHeadlineFontSize = CGFloat(448.00) /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    public static let componentTeaserATeaserATeaserHeadlineLineHeight = CGFloat(448.00)
    public static let componentTeaserATeaserATeaserKickerFontSize = CGFloat(256.00) /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    public static let componentTeaserATeaserATeaserKickerLineHeight = CGFloat(256.00)
    public static let componentTeaserATeaserATeaserTitleInlineSpace = CGFloat(128.00)
    public static let componentTeaserBTeaserBTeaserTitleInlineSpace = CGFloat(128.00)
    public static let componentTeaserBildPlayBildPlayTeaserWidthSize = CGFloat(2320.00)
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontSize = CGFloat(352.00) /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 600
    public static let componentTeaserMQTeaserMQTeaserHeadlineLineHeight = CGFloat(352.00)
    public static let componentTeaserMQTeaserMqTeaserTitleInlineSpace = CGFloat(128.00)
    public static let componentTeaserQTeaserQTeaserTitleInlineSpace = CGFloat(128.00)
    public static let componentTeaserQTeaserQuadHeadlineFontSize = CGFloat(768.00) /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    public static let componentTeaserQTeaserQuadHeadlineLineHeight = CGFloat(768.00)
    public static let componentTeaserQTeaserQuadKickerFontSize = CGFloat(288.00)
    public static let componentTeaserStdTeaserStdTeaserBadgesMarginSpace = CGFloat(64.00) /** This variable is used for creating space around the outside of a subscription badge or video icon badge. */
    public static let componentTeaserStdTeaserStdTeaserImageTitleGapSpace = CGFloat(64.00)
    ...
    public static let componentTeaserTeaserBadgesHeightSizeSm = CGFloat(384.00)
    ...
    public static let componentTeaserTeaserTitleBottomStackSpace = CGFloat(192.00)
    public static let componentTeaserTeaserTitleGapSpace = CGFloat(64.00)
    public static let componentTeaserTeaserTitleInlineLeftSpace = CGFloat(192.00)
    public static let componentTeaserTeaserTitleStackSpace = CGFloat(64.00)
    public static let componentToggleSwitchAppToggleItemLabelFontSize = CGFloat(224.00) /** This variable is used on labels in list items with toggle switches found in app preferences. 14 - 14 - 16 - 18 */
    public static let componentToggleSwitchAppToggleItemLabelLineHeight = CGFloat(225.60) /** This variable is used on labels in list items with toggle switches found in app preferences. 14.1 - 14.1 - 16.2 - 18.2 */
    public static let componentVideoVerticalVideoMockHeadlineFontSize = CGFloat(352.00)
    public static let componentVideoVideoAdBadgeFontSize = CGFloat(224.00) /** 14 - 14 - 16 - 16 -- This variable is used in the videoAdBadge font size parameter. */
    public static let componentVideoVideoBadgeTimeLineHeight = CGFloat(336.00)
    public static let componentVideoVideoFrameInlineSpace = CGFloat(0.00)
    public static let componentVideoVideoRedPlayIconHeightSize = CGFloat(160.00) /** This variable is used for changing the red play icon inside the white square. */
    public static let componentVideoVideoRedPlayIconWidthSize = CGFloat(128.00)
    public static let componentVideoVideoSkeletonContainerHeight = CGFloat(2880.00)
    ...
    public static let componentVideoVideoTimeBadgeFontSize = CGFloat(256.00) /** 16 - 16 - 18 - 18 -- This variable is used to control the videoTimeBadge text style's font size parameter. The typography style that uses this variable is the videoTimeBadge style. The badge that uses this variable appears on the upper right corner of horizontal videos. */
    public static let componentVideoVideoTimeBadgeSize = CGFloat(384.00) /** 24 - 24 - 32 - 40 - This variable is used on horizontal video badges that contain a red play icon on top of a white square next to a timestamp. */
 ...
 */
semanticLayoutBreakpointsBreakpointMaxWidthSize = CGFloat(9584.00)
    public static let /**
 ...
 */
semanticLayoutBreakpointsBreakpointMinWidthSize = CGFloat(6240.00)
    public static let /**
 ...
 */
semanticLayoutCanvasHeightSizeApp = CGFloat(13504.00)
    public static let /**
 * Common viewport height size based on the selected mode.
 * Apply this token to the main frame of page layouts to simulate realistic vertical space.
 */
semanticLayoutCanvasHeightSizeWeb = CGFloat(13504.00)
    public static let /**
 * Common viewport width size based on the selected breakpoint.
 * Apply this token to the main frame of page layouts.
 */
semanticLayoutCanvasWidthSizeApp = CGFloat(6240.00)
    public static let /**
 * Common viewport width size based on the selected breakpoint.
 * Apply this token to the main frame of page layouts.
 */
semanticLayoutCanvasWidthSizeWeb = CGFloat(6240.00)
    ...
    public static let semanticLayoutGridLayoutGuideLayoutGuideGridColums = CGFloat(64.00) /** Used to set the column count in Figma Layout guide Grids */
    ...
    public static let semanticLayoutGridResponsiveGridSpaceRespLg = CGFloat(384.00) /** 24-24-32-32 – use for side paddings and gutters in responsive layouts */
    ...
    public static let semanticLayoutGridResponsiveGridSpaceRespXl = CGFloat(768.00) /** 48-48-64-64 – use for side paddings and gutters in responsive layouts */
    ...
    public static let semanticLayoutSectionParagraphEndSpace = CGFloat(256.00) /** 16-16-32-32 – Use for spacing after paragraphs in text content */
    public static let semanticLayoutSectionSectionSpaceBase = CGFloat(576.00) /** 36-36-48-48 – Use for vertical spacing between sections in a layout. */
    public static let semanticLayoutSectionSectionSpaceLg = CGFloat(1152.00) /** 72-72-96-96 – Use for vertical spacing between sections in a layout */
    public static let semanticLayoutSectionSectionSpaceSm = CGFloat(384.00) /** 24-24-36-36 – Use for vertical spacing between subsections in a layout */
    ...
    public static let semanticSizeResponsiveSizeResp2Xl = CGFloat(1152.00) /** 72-72-92-100 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeResp2Xs = CGFloat(384.00) /** 24-24-32-32 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeResp3Xl = CGFloat(1536.00) /** 96-96-120-148 – Use for setting height and width of UI elements that scale across breakpoints */
    ...
    public static let semanticSizeResponsiveSizeResp4Xl = CGFloat(2368.00) /** 148-148-160-180 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeResp4Xs = CGFloat(192.00) /** 12-12-14-16 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeRespLg = CGFloat(896.00) /** 56-56-72-92 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeRespMd = CGFloat(768.00) /** 48-48-64-72 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeRespSm = CGFloat(640.00) /** 40-40-48-56 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeRespXl = CGFloat(1024.00) /** 64-64-80-96 – Use for setting height and width of UI elements that scale across breakpoints */
    public static let semanticSizeResponsiveSizeRespXs = CGFloat(512.00) /** 32-32-40-48 – Use for setting height and width of UI elements that scale across breakpoints */
    ...
    public static let semanticSpaceGapResponsiveGapSpaceResp2Xl = CGFloat(512.00) /** 32-32-48-64 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceResp2Xs = CGFloat(32.00) /** 2-2-4-6 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceResp3Xl = CGFloat(768.00) /** 48-48-72-96 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceRespLg = CGFloat(256.00) /** 16-16-24-32 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceRespMd = CGFloat(192.00) /** 12-12-16-24 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceRespSm = CGFloat(128.00) /** 8-8-12-16 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceRespXl = CGFloat(384.00) /** 24-24-32-48 – Use for gaps between items inside of UI elements that scale across breakpoints */
    public static let semanticSpaceGapResponsiveGapSpaceRespXs = CGFloat(64.00) /** 4-4-6-8 – Use for gaps between items inside of UI elements that scale across breakpoints */
    ...
    public static let semanticSpaceInlineResponsiveInlineSpaceResp2Xl = CGFloat(512.00) /** 32-32-48-64 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceInlineResponsiveInlineSpaceRespLg = CGFloat(256.00) /** 16-16-24-32 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceInlineResponsiveInlineSpaceRespMd = CGFloat(192.00) /** 12-12-16-24 use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceInlineResponsiveInlineSpaceRespSm = CGFloat(128.00) /** 8-8-12-16 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceInlineResponsiveInlineSpaceRespXl = CGFloat(384.00) /** 24-24-32-40 – use for horizontal (left/right) padding of UI elements that scales across breakpoints */
    ...
    public static let semanticSpaceStackResponsiveStackSpaceResp2Xl = CGFloat(512.00) /** 32-32-48-64 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceStackResponsiveStackSpaceRespLg = CGFloat(256.00) /** 16-16-24-32 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceStackResponsiveStackSpaceRespMd = CGFloat(192.00) /** 12-12-16-24 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceStackResponsiveStackSpaceRespSm = CGFloat(128.00) /** 8-8-12-16 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    public static let semanticSpaceStackResponsiveStackSpaceRespXl = CGFloat(384.00) /** 24-24-32-40 – use for vertical (top/bottom) padding of UI elements that scales across breakpoints */
    ...
    public static let semanticTypographyFontSizeBodyBodyFontSize = CGFloat(336.00) /** This variable is used on the body text style's font size parameter. It remains constant at 21. */
    public static let semanticTypographyFontSizeCalloutCallout1FontSize = CGFloat(288.00) /** This token is used for the font size parameter of the callout text style. 18 - 18 - 22 - 22 */
    public static let semanticTypographyFontSizeDisplayDisplay1FontSize = CGFloat(640.00) /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    public static let semanticTypographyFontSizeDisplayDisplay2FontSize = CGFloat(576.00) /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let semanticTypographyFontSizeDisplayDisplay3FontSize = CGFloat(448.00) /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    public static let semanticTypographyFontSizeFootnoteFootnote1FontSize = CGFloat(256.00) /** This token is used on the footnote text style font size parameter. 16 - 16 - 16 - 18 */
    public static let semanticTypographyFontSizeFootnoteFootnote2FontSize = CGFloat(192.00) /** This token is used in the font size parameter of the footnote2 text style. 12 - 12 - 12 - 16 */
    public static let semanticTypographyFontSizeHeadlineHeadline1FontSize = CGFloat(768.00) /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    public static let semanticTypographyFontSizeHeadlineHeadline2FontSize = CGFloat(640.00) /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    public static let semanticTypographyFontSizeHeadlineHeadline3FontSize = CGFloat(448.00) /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    public static let semanticTypographyFontSizeHeadlineHeadline4FontSize = CGFloat(352.00) /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    ...
    public static let semanticTypographyFontSizeKickerKicker3FontSize = CGFloat(256.00) /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. 16 - 16 - 18 - 20 */
    ...
    public static let semanticTypographyFontSizeLabelLabel1FontSizeResponsive = CGFloat(160.00) /** 10 - 10 - 15 - 17 Use this label font size when you want your label's font size to change across device sizes. */
    ...
    public static let semanticTypographyFontSizeSubheadlineSubheadline1FontSize = CGFloat(384.00) /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    public static let semanticTypographyLetterSpacingDisplayDisplay1LetterSpacing = CGFloat(-8.00) /** -0.5 | -0.5 | -1 | -2 | This variable is used for the letter spacing parameter of the display1 text style. On smaller devices the value is smaller than on larger devices. On desktop devices the letter spacing is further reduced for making the text style more compact. */
    public static let semanticTypographyLetterSpacingDisplayDisplay2LetterSpacing = CGFloat(-8.00) /** -0.5 | -0.5 | -1 | -1 | This variable is used for the letter spacing parameter of the display2 text style. On smaller devices the value is smaller than on larger devices. */
    public static let semanticTypographyLetterSpacingDisplayDisplay3LetterSpacing = CGFloat(-8.00) /** -0.5 | -0.5 | -1 | -1 | This variable is used for the letter spacing parameter of the display3 text style. On smaller devices the value is smaller than on larger devices. */
    ...
    public static let semanticTypographyLetterSpacingLetterSpacingNegativeSm = CGFloat(-8.00) /** -0.5 | -0.5 | -0.25 | -0.25 | This variable takes primitive letter spacing variables and creates this semantic variable for use on designs that change across device sizes. */
    ...
    public static let semanticTypographyLineHeightBodyBodyLineHeight = CGFloat(448.00) /** Figma's font line height currently does not allow for multipliers as is used on current website css var(--body-line-height) */
    public static let semanticTypographyLineHeightCalloutCalloutLineHeight = CGFloat(288.00)
    public static let semanticTypographyLineHeightDisplayDisplay1LineHeight = CGFloat(640.00)
    public static let semanticTypographyLineHeightDisplayDisplay2LineHeight = CGFloat(576.00)
    public static let semanticTypographyLineHeightDisplayDisplay3LineHeight = CGFloat(448.00)
    public static let semanticTypographyLineHeightFootnoteFootnote1LineHeight = CGFloat(336.00)
    public static let semanticTypographyLineHeightFootnoteFootnote2LineHeight = CGFloat(249.60)
    public static let semanticTypographyLineHeightHeadlineHeadline1LineHeight = CGFloat(768.00)
    public static let semanticTypographyLineHeightHeadlineHeadline2LineHeight = CGFloat(640.00)
    public static let semanticTypographyLineHeightHeadlineHeadline3LineHeight = CGFloat(448.00)
    public static let semanticTypographyLineHeightHeadlineHeadline4LineHeight = CGFloat(352.00)
    ...
    public static let semanticTypographyLineHeightKickerKicker3LineHeight = CGFloat(281.60)
    public static let semanticTypographyLineHeightKickerKicker4LineHeight = CGFloat(246.40)
    public static let semanticTypographyLineHeightLabelLabel1LineHeight = CGFloat(272.00) /** This variable is used in the label1 text style's line height parameter. It references branding variables for brand specific line heights. */
    public static let semanticTypographyLineHeightLabelLabel1ResponsiveLineHeight = CGFloat(160.00)
    ...
    public static let semanticTypographyLineHeightQuoteQuoteLineHeight = CGFloat(256.00) /** This variable is used in the quote text style line height parameter. */
    public static let semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = CGFloat(384.00)
    public static let semanticTypographyLineHeightTitleTitle1LineHeight = CGFloat(352.00)
    public static let semanticTypographyLineHeightTitleTitle2LineHeight = CGFloat(281.60) /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
