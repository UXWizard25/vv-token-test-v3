...
In the previous system, this style was named Caption. For greater clarity and consistency, it has been renamed to title2. Font size: 16 - 16 - 18 - 20 */
        ...
        static let articlekicker = UIFont(name: "Gotham XNarrow", size: 30)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 30, weight: .light)
        /** This text style is used on image captions that show up in article pages only. */
        static let articleimagecaption = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        ...
        static let articleheadline = UIFont(name: "Gotham Condensed", size: 100)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 100, weight: .light)
        ...
        static let articlemetasource = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        ...
        static let audioplayerlabel = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        ...
        static let appavatar = UIFont(name: "Gotham", size: 16)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 16, weight: .heavy)
...
09-2025, on large devices this component uses the css var --footnote-font-size-lg at 1024px bp changes to --footnote-font-size-sm */
        static let avatardefault = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        /** This text style is used on avatars that appear in article pages. Font size: 16 - 16 - 16 - 18 */
        static let avatarhover = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        ...
        static let avatarsecondaryinfo = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        ...
        static let avatarsecondaryinfohover = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        ...
        static let breadcrumb = UIFont(name: "Gotham XNarrow", size: 12)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 12, weight: .bold)
        ...
        static let breadcrumblink = UIFont(name: "Gotham XNarrow", size: 12)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 12, weight: .bold)
        ...
        static let breadcrumblinkhover = UIFont(name: "Gotham XNarrow", size: 12)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 12, weight: .bold)
        ...
        static let breakingnewsuppertitle = UIFont(name: "Gotham", size: 17)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 17, weight: .heavy)
        /** Use this font style on the breaking news badge's lower title. Font size constant 23. */
        static let breakingnewslowertitle = UIFont(name: "Gotham", size: 30)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 30, weight: .heavy)
        ...
        static let livetickerheadline = UIFont(name: "Gotham Condensed", size: 32)?.withWeight(.semibold) ?? UIFont.systemFont(ofSize: 32, weight: .semibold)
        ...
        static let podcastplayerlabel = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        ...
        static let videoplayertime = UIFont(name: "Gotham", size: 18)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 18, weight: .heavy)
        ...
        static let apptopbarstagetitle = UIFont(name: "Gotham", size: 14)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 14, weight: .heavy)
        ...
        static let apptopbartabstitle = UIFont(name: "Gotham", size: 14)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 14, weight: .heavy)
        ...
        static let newstickertimestamp = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        ...
        static let newstickerkicker = UIFont(name: "Gotham XNarrow", size: 20)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 20, weight: .bold)
        /** This text style is used on NewsTicker Headlines. It references the semantic level text style headline3. 28 - 28 - 36 - 40 */
        static let newstickerheadline = UIFont(name: "Gotham Condensed", size: 40)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 40, weight: .light)
