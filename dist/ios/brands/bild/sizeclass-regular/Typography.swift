...
extension UIFont {
    struct TypographyBildregular {
        ...
        static let display_display1 = UIFont(name: "Gotham", size: 120)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 120, weight: .heavy)
        ...
        static let display_display2 = UIFont(name: "Gotham", size: 64)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 64, weight: .heavy)
        ...
        static let display_display3 = UIFont(name: "Gotham", size: 40)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 40, weight: .heavy)
        ...
        static let headline_headline1 = UIFont(name: "Gotham Condensed", size: 100)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 100, weight: .light)
        ...
        static let headline_headline2 = UIFont(name: "Gotham Condensed", size: 64)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 64, weight: .light)
        ...
        static let headline_headline3 = UIFont(name: "Gotham Condensed", size: 40)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 40, weight: .light)
        ...
        static let headline_headline4 = UIFont(name: "Gotham Condensed", size: 32)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 32, weight: .light)
        ...
        static let subheadline_subheadline1 = UIFont(name: "Gotham Condensed", size: 36)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 36, weight: .bold)
        ...
        static let kicker_kicker1 = UIFont(name: "Gotham XNarrow", size: 30)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 30, weight: .light)
        ...
        static let kicker_kicker2 = UIFont(name: "Gotham XNarrow", size: 24)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 24, weight: .light)
        ...
        static let kicker_kicker3 = UIFont(name: "Gotham XNarrow", size: 20)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 20, weight: .light)
        ...
        static let kicker_kicker4 = UIFont(name: "Gotham XNarrow", size: 16)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 16, weight: .light)
        ...
        static let title_title1 = UIFont(name: "Gotham", size: 28)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 28, weight: .heavy)
        /** Title styles are mid-level headings, often used for module names, card headers, or section labels. They balance prominence with readability. Font size: 22 - 22 - 22 - 28 */
        static let title_title1uppercase = UIFont(name: "Gotham", size: 28)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 28, weight: .heavy)
...
In the previous system, this style was named Caption. For greater clarity and consistency, it has been renamed to title2. Font size: 16 - 16 - 18 - 20 */
        static let title_title2 = UIFont(name: "Gotham", size: 20)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 20, weight: .heavy)
        /** Title styles are mid-level headings, often used for module names, card headers, or section labels. They balance prominence with readability. 

In the previous system, this style was named Caption. For greater clarity and consistency, it has been renamed to title2. Font size: 16 - 16 - 18 - 20 */
        static let title_title2uppercase = UIFont(name: "Gotham", size: 20)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 20, weight: .heavy)
        ...
        static let callout_callout = UIFont(name: "Gotham", size: 22)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 22, weight: .heavy)
        ...
        static let footnote_footnote1 = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        ...
        static let footnote_footnote1bold = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        ...
        static let footnote_footnote2 = UIFont(name: "Gotham XNarrow", size: 16)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 16, weight: .light)
        /** Footnotes are used for disclaimers, annotations, or secondary details. They are small in size and carry low visual weight. This text style should be chosen when longer small descriptive texts in a small font size is needed where as the label text style should be used for shorter identifier texts. Font size: 12 - 12 - 12 - 16 */
        static let footnote_footnote2bold = UIFont(name: "Gotham XNarrow", size: 16)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 16, weight: .bold)
        ...
        static let label_label1boldresp = UIFont(name: "Gotham XNarrow", size: 17)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 17, weight: .bold)
        /** Labels identify interface elements such as form fields, buttons, or navigation items. They ensure clarity and usability in functional contexts. This text style should be chosen when shorter small identifier texts in a small font size is needed where as the footnote text style should be used for longer descriptive texts. This text style's font size value remains constant at 17 across device sizes. */
        ...
        static let quote_quote = UIFont(name: "Gotham", size: 20)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 20, weight: .heavy)
        ...
        static let article_articlekicker = UIFont(name: "Gotham XNarrow", size: 30)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 30, weight: .light)
        /** This text style is used on image captions that show up in article pages only. */
        static let article_articleimagecaption = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        ...
        static let article_articleheadline = UIFont(name: "Gotham Condensed", size: 100)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 100, weight: .light)
        ...
        static let article_articlemetasource = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        ...
        static let article_articletimestamp = UIFont(name: "Gotham", size: 16)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 16, weight: .heavy)
        ...
        static let audioplayer_audioplayerlabel = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        /** This text style is used for avatar on iOS & Android apps. 12 - 12 - 14 - 16 */
        static let avatar_appavatar = UIFont(name: "Gotham", size: 16)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 16, weight: .heavy)
...
09-2025, on large devices this component uses the css var --footnote-font-size-lg at 1024px bp changes to --footnote-font-size-sm */
        static let avatar_avatardefault = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        /** This text style is used on avatars that appear in article pages. Font size: 16 - 16 - 16 - 18 */
        static let avatar_avatarhover = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        ...
        static let avatar_avatarsecondaryinfo = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        ...
        static let avatar_avatarsecondaryinfohover = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        ...
        static let badges_videotimebadge = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        ...
        static let breadcrumb_breadcrumb = UIFont(name: "Gotham XNarrow", size: 12)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 12, weight: .bold)
        ...
        static let breadcrumb_breadcrumblink = UIFont(name: "Gotham XNarrow", size: 12)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 12, weight: .bold)
        ...
        static let breadcrumb_breadcrumblinkhover = UIFont(name: "Gotham XNarrow", size: 12)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 12, weight: .bold)
        ...
        static let breakingnews_breakingnewsuppertitle = UIFont(name: "Gotham", size: 17)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 17, weight: .heavy)
        /** Use this font style on the breaking news badge's lower title. Font size constant 23. */
        static let breakingnews_breakingnewslowertitle = UIFont(name: "Gotham", size: 30)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 30, weight: .heavy)
        ...
        static let button_partnerlinkbuttonlabel = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        /** This text style is used on the chips component. They are commonly used for filtering parameters. font size: 16 - 16 - 16 - 18 */
        static let chips_chipslabel = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        ...
        static let liveticker_livetickerheadline = UIFont(name: "Gotham Condensed", size: 32)?.withWeight(.semibold) ?? UIFont.systemFont(ofSize: 32, weight: .semibold)
        ...
        static let mediaplayers_podcastplayerlabel = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        ...
        static let mediaplayers_videoplayertime = UIFont(name: "Gotham", size: 18)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 18, weight: .heavy)
        /** This text style is used on a small title that is placed above tab elements that are seen on iOS and Android top menu bar. */
        static let menu_apptopbarstagetitle = UIFont(name: "Gotham", size: 14)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 14, weight: .heavy)
        ...
        static let menu_apptopbartabstitle = UIFont(name: "Gotham", size: 14)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 14, weight: .heavy)
        ...
        static let newsticker_newstickertimestamp = UIFont(name: "Gotham XNarrow", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        ...
        static let newsticker_newstickerkicker = UIFont(name: "Gotham XNarrow", size: 20)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 20, weight: .bold)
        /** This text style is used on NewsTicker Headlines. It references the semantic level text style headline3. 28 - 28 - 36 - 40 */
        static let newsticker_newstickerheadline = UIFont(name: "Gotham Condensed", size: 40)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 40, weight: .light)
        ...
        static let tabs_appbottombarlabeldefault = UIFont(name: "Gotham XNarrow", size: 16)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 16, weight: .light)
        /** Labels identify interface elements such as form fields, buttons, or navigation items. They ensure clarity and usability in functional contexts. */
        static let tabs_appbottombarlabelactive = UIFont(name: "Gotham XNarrow", size: 16)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 16, weight: .bold)
        ...
        static let ateaser_ateaserkicker = UIFont(name: "Gotham XNarrow", size: 24)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 24, weight: .light)
        /** This text style references the semantic text styles headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
        static let ateaser_ateaserheadline = UIFont(name: "Gotham Condensed", size: 64)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 64, weight: .light)
        /** This component level text style references size variables for the semantic level. Specifically kicker4. 14 - 14 - 16 - 16 */
        static let mqteaser_mqteaserkicker = UIFont(name: "Gotham XNarrow", size: 16)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 16, weight: .light)
...
XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
        static let mqteaser_mqteaserheadline = UIFont(name: "Gotham Condensed", size: 40)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 40, weight: .light)
        ...
        static let qteaser_qteaserheadline = UIFont(name: "Gotham Condensed", size: 100)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 100, weight: .light)
        ...
        static let stdteaser_stdteaserheadline = UIFont(name: "Gotham Condensed", size: 32)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 32, weight: .light)
        /** This text style is used on labels in list items with toggle switches found in app preferences. 14 - 14 - 16 - 18 */
        static let toggleswitches_apptoogleitemlabel = UIFont(name: "Gotham", size: 18)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 18, weight: .heavy)
        ...
        static let .dsdocsstyles_.codesnippets = UIFont(name: "Source Code Pro", size: 16)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 16, weight: .light)
