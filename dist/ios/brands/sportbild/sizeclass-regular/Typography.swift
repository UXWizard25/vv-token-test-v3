...
In the previous system, this style was named Caption. For greater clarity and consistency, it has been renamed to title2. Font size: 16 - 16 - 18 - 20 */
        ...
        static let articlekicker = UIFont(name: "AntennaExtraCond", size: 32)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 32, weight: .light)
        /** This text style is used on image captions that show up in article pages only. */
        static let articleimagecaption = UIFont(name: "Inter", size: 15)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 15, weight: .bold)
        ...
        static let articleheadline = UIFont(name: "AntennaExtraCond", size: 80)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 80, weight: .light)
        ...
        static let articlemetasource = UIFont(name: "Inter", size: 15)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 15, weight: .light)
        ...
        static let audioplayerlabel = UIFont(name: "AntennaExtraCond", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        ...
        static let appavatar = UIFont(name: "AntennaCond", size: 16)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 16, weight: .heavy)
...
09-2025, on large devices this component uses the css var --footnote-font-size-lg at 1024px bp changes to --footnote-font-size-sm */
        static let avatardefault = UIFont(name: "Inter", size: 15)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 15, weight: .bold)
        /** This text style is used on avatars that appear in article pages. Font size: 16 - 16 - 16 - 18 */
        static let avatarhover = UIFont(name: "Inter", size: 15)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 15, weight: .bold)
        ...
        static let avatarsecondaryinfo = UIFont(name: "Inter", size: 15)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 15, weight: .light)
        ...
        static let avatarsecondaryinfohover = UIFont(name: "Inter", size: 15)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 15, weight: .light)
        ...
        static let breadcrumb = UIFont(name: "Inter", size: 11)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 11, weight: .bold)
        ...
        static let breadcrumblink = UIFont(name: "Inter", size: 11)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 11, weight: .light)
        ...
        static let breadcrumblinkhover = UIFont(name: "Inter", size: 11)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 11, weight: .bold)
        ...
        static let breakingnewsuppertitle = UIFont(name: "AntennaCond", size: 17)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 17, weight: .heavy)
        /** Use this font style on the breaking news badge's lower title. Font size constant 23. */
        static let breakingnewslowertitle = UIFont(name: "AntennaCond", size: 30)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 30, weight: .heavy)
        ...
        static let livetickerheadline = UIFont(name: "AntennaExtraCond", size: 32)?.withWeight(.semibold) ?? UIFont.systemFont(ofSize: 32, weight: .semibold)
        ...
        static let podcastplayerlabel = UIFont(name: "AntennaExtraCond", size: 18)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 18, weight: .light)
        ...
        static let videoplayertime = UIFont(name: "AntennaCond", size: 18)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 18, weight: .heavy)
        ...
        static let apptopbarstagetitle = UIFont(name: "AntennaCond", size: 13)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 13, weight: .heavy)
        ...
        static let apptopbartabstitle = UIFont(name: "AntennaCond", size: 13)?.withWeight(.heavy) ?? UIFont.systemFont(ofSize: 13, weight: .heavy)
        ...
        static let newstickertimestamp = UIFont(name: "AntennaExtraCond", size: 18)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 18, weight: .bold)
        ...
        static let newstickerkicker = UIFont(name: "AntennaExtraCond", size: 22)?.withWeight(.bold) ?? UIFont.systemFont(ofSize: 22, weight: .bold)
        /** This text style is used on NewsTicker Headlines. It references the semantic level text style headline3. 28 - 28 - 36 - 40 */
        static let newstickerheadline = UIFont(name: "AntennaExtraCond", size: 34)?.withWeight(.light) ?? UIFont.systemFont(ofSize: 34, weight: .light)
