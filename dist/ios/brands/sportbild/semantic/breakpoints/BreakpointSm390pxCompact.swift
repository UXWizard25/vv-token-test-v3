...
public class BreakpointSm390pxCompact {
    ...
    public static let componentArticleArticleHeadlineFontSize = CGFloat(672.00) /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    public static let componentArticleArticleKickerFontSize = CGFloat(320.00) /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    public static let componentTeaserATeaserATeaserHeadlineFontSize = CGFloat(480.00) /** This variable references the semantic variables headline3 (XS&SM) and headline2 (MD&LG). 28 - 28 - 48 - 64 */
    public static let componentTeaserATeaserATeaserHeadlineLineHeight = CGFloat(480.00)
    ...
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontSize = CGFloat(336.00) /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700
    public static let componentTeaserMQTeaserMQTeaserHeadlineLineHeight = CGFloat(369.60)
    public static let componentTeaserMQTeaserMqTeaserTitleInlineSpace = CGFloat(192.00)
    public static let componentTeaserQTeaserQTeaserTitleInlineSpace = CGFloat(192.00)
    public static let componentTeaserQTeaserQuadHeadlineFontSize = CGFloat(672.00) /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    public static let componentTeaserQTeaserQuadHeadlineLineHeight = CGFloat(672.00)
    public static let componentTeaserQTeaserQuadKickerFontSize = CGFloat(320.00)
...
semanticLayoutCanvasWidthSizeWeb = CGFloat(6240.00)
    ...
    public static let semanticTypographyFontSizeDisplayDisplay1FontSize = CGFloat(608.00) /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    public static let semanticTypographyFontSizeDisplayDisplay2FontSize = CGFloat(544.00) /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    ...
    public static let semanticTypographyFontSizeHeadlineHeadline1FontSize = CGFloat(672.00) /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    public static let semanticTypographyFontSizeHeadlineHeadline2FontSize = CGFloat(672.00) /** This token is used on the headline2 text style's font size parameter. 40 - 40 - 48 - 64 */
    ...
    public static let semanticTypographyFontSizeHeadlineHeadline4FontSize = CGFloat(336.00) /** This token controls the headline4 text style's font size parameter: 22 - 22 - 26 - 32 */
    public static let semanticTypographyFontSizeKickerKicker1FontSize = CGFloat(320.00) /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    ...
    public static let semanticTypographyFontSizeTitleTitle1FontSize = CGFloat(384.00) /** 22 - 22 - 22 - 28 -- html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
    ...
    public static let semanticTypographyLineHeightCalloutCalloutLineHeight = CGFloat(374.40)
    ...
    public static let semanticTypographyLineHeightHeadlineHeadline1LineHeight = CGFloat(672.00)
    public static let semanticTypographyLineHeightHeadlineHeadline2LineHeight = CGFloat(672.00)
    public static let semanticTypographyLineHeightHeadlineHeadline3LineHeight = CGFloat(528.00)
    public static let semanticTypographyLineHeightHeadlineHeadline4LineHeight = CGFloat(369.60)
    public static let semanticTypographyLineHeightKickerKicker1LineHeight = CGFloat(352.00)
    ...
    public static let semanticTypographyLineHeightLabelLabel1ResponsiveLineHeight = CGFloat(192.00)
    ...
    public static let semanticTypographyLineHeightTitleTitle2LineHeight = CGFloat(332.80) /** html class stage-block-title__text css var --ressort-header-font-size(sm-md-lg) */
