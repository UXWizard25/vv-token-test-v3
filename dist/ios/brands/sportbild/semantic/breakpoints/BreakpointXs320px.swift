...
public class BreakpointXs320px {
    ...
    public static let ArticleImageCaptionLineHeight = "16.899999618530273px"
    public static let ArticleImageSourceLineHeight = "17px"
...
Apply this token to the main frame of page layouts to simulate realistic maximum widths across responsive viewports. */
    ...
    public static let Headline2FontSize = "42px"
    /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    public static let Headline3FontSize = "30px"
