...
public class ColormodeLight {
    ...
    public static let MenuScrolledSurfaceGradientColor = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.950)
    ...
    public static let AppTopBarTextColorPrimary = UIColor(red: 0.137, green: 0.149, blue: 0.161, alpha: 1.000)
    ...
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    public static let PartnerLinksBorderColorActive = UIColor(red: 0.137, green: 0.149, blue: 0.161, alpha: 1.000)
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    public static let PartnerLinksBgColorIdle = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 1.000)
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    public static let PartnerLinksBgColorActive = UIColor(red: 0.914, green: 0.925, blue: 0.937, alpha: 1.000)
    /** !do not use! these variables have been deprecated and multitext link buttons are now classified as partner buttons. */
    ...
    public static let TabLabelColorActive = UIColor(red: 0.204, green: 0.235, blue: 0.255, alpha: 1.000)
