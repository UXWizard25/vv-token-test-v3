...
public class BreakpointLg1024pxRegular {
    ...
    public static let componentArticleArticleHeadlineFontSize = CGFloat(1120.00) /** 40 - 40 - 72 - 100 - This variable uses the semantic variables headline2 for XS&SM, headline1 for MD&LG */
    ...
    public static let componentArticleArticleImageCaptionLineHeight = CGFloat(384.00) /** this component level variable references the branding variables */
    ...
    public static let componentArticleArticleImageSourceLineHeight = CGFloat(384.00)
    ...
    public static let componentArticleArticleKickerFontSize = CGFloat(400.00) /** This variable is used to control the font size of kickers in the heading section of article pages. 18 - 18 - 22 - 30 */
    ...
    public static let componentTeaserATeaserATeaserHeadlineLineHeight = CGFloat(844.80)
    public static let componentTeaserATeaserATeaserKickerFontSize = CGFloat(336.00) /** 16 - 16 - 22 - 24 This variable references the semantic variables kicker3fontsize and kicker2fontsize. At the 600px breakpoint smaller devices use the kicker3 variable */
    public static let componentTeaserATeaserATeaserKickerLineHeight = CGFloat(336.00)
    ...
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontSize = CGFloat(512.00) /** XS-headline4FontSize:22 // SM-headline4FontSize:22 // MD-headline3FontSize:36 // LG-headline3FontSize:40 */
    public static let componentTeaserMQTeaserMQTeaserHeadlineFontWeight = 700
    public static let componentTeaserMQTeaserMQTeaserHeadlineLineHeight = CGFloat(563.20)
    ...
    public static let componentTeaserQTeaserQuadHeadlineFontSize = CGFloat(1120.00) /** This component level variable is used on the quad teaser headline. It references the semantic level variable headline1. 48 - 48 - 72 - 100 */
    public static let componentTeaserQTeaserQuadHeadlineLineHeight = CGFloat(1232.00)
    public static let componentTeaserQTeaserQuadKickerFontSize = CGFloat(336.00)
...
semanticLayoutCanvasWidthSizeWeb = CGFloat(16384.00)
    ...
    public static let semanticTypographyFontSizeDisplayDisplay1FontSize = CGFloat(1856.00) /** This variable is used on the font size parameter for the display1 text style. 40 - 40 - 72 - 120 */
    public static let semanticTypographyFontSizeDisplayDisplay2FontSize = CGFloat(992.00) /** This variable is used for the font size parameter of the Display2 text style. 36 - 36 - 42 - 64 */
    public static let semanticTypographyFontSizeDisplayDisplay3FontSize = CGFloat(624.00) /** This variable is used on the display3 font size parameter of the display3 text style. 28 - 28 - 32 - 40 */
    ...
    public static let semanticTypographyFontSizeHeadlineHeadline1FontSize = CGFloat(1120.00) /** This token is used for the headline1 text style's font size parameter. 48 - 48 - 72 - 100 */
    ...
    public static let semanticTypographyFontSizeHeadlineHeadline3FontSize = CGFloat(512.00) /** This token is used on the headline3 text style's font size parameter. 28 - 28 - 36 - 40 */
    ...
    public static let semanticTypographyFontSizeKickerKicker1FontSize = CGFloat(400.00) /** Values come from NMT Figma File 01_Foundation; in online CSS this is kicker0. 18 - 18 - 22 - 30 - This variable does not exist yet in online css. Online css is called kicker0 for smallest font size. */
    public static let semanticTypographyFontSizeKickerKicker2FontSize = CGFloat(336.00) /** Values come from comparing NMT Figma File 01_Foundation to online CSS. Online kickers are numbered from 0 to 3. This DS uses 1 to 4 following html convention of h1, h2, h3, etc. 18 - 18 - 22 - 24 */
    ...
    public static let semanticTypographyFontSizeSubheadlineSubheadline1FontSize = CGFloat(448.00) /** This token controls the subheadline1 font size parameter. 24 - 24 - 32 - 36 */
    ...
    public static let semanticTypographyLineHeightFootnoteFootnote1LineHeight = CGFloat(312.00)
    public static let semanticTypographyLineHeightFootnoteFootnote2LineHeight = CGFloat(270.40)
    public static let semanticTypographyLineHeightHeadlineHeadline1LineHeight = CGFloat(1232.00)
    public static let semanticTypographyLineHeightHeadlineHeadline2LineHeight = CGFloat(844.80)
    public static let semanticTypographyLineHeightHeadlineHeadline3LineHeight = CGFloat(563.20)
    public static let semanticTypographyLineHeightHeadlineHeadline4LineHeight = CGFloat(440.00)
    public static let semanticTypographyLineHeightKickerKicker1LineHeight = CGFloat(440.00)
    public static let semanticTypographyLineHeightKickerKicker2LineHeight = CGFloat(369.60)
    ...
    public static let semanticTypographyLineHeightSubheadlineSubheadline1LineHeight = CGFloat(582.40)
    public static let semanticTypographyLineHeightTitleTitle1LineHeight = CGFloat(537.60)
